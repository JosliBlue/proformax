...
`
    ...
    for (let d = 0; d < t.length; d++) {
      ...
      if (c === we) (l += t.slice(d, d + 2)), (d += 1);
      else if (c === Ue && t.charCodeAt(d + 1) === _e) {
        let m = d;
        for (let y = d + 2; y < t.length; y++)
          if (((f = t.charCodeAt(y)), f === we)) y += 1;
          else if (f === _e && t.charCodeAt(y + 1) === Ue) {
            d = y + 1;
            break;
          }
        let g = t.slice(m, d + 1);
        g.charCodeAt(2) === pn && n.push(je(g.slice(2, -2)));
      } else if (c === un || c === sn) {
        let m = d;
        for (let g = d + 1; g < t.length; g++)
          if (((f = t.charCodeAt(g)), f === we)) g += 1;
          else if (f === c) {
            d = g;
            break;
          } else {
            if (f === Ke && t.charCodeAt(g + 1) === ae)
              throw new Error(
                `Unterminated string: ${
        ...
        if (c === ae) {
          ...
          (f = l.charCodeAt(l.length - 1)),
            f !== xe && f !== ae && f !== De && (l += " ");
        } else if (c === Ot && t.charCodeAt(d + 1) === Ot && l.length === 0) {
          let m = "",
            g = d,
            y = -1;
          for (let k = d + 2; k < t.length; k++)
            if (((f = t.charCodeAt(k)), f === we)) k += 1;
            else if (f === Ue && t.charCodeAt(k + 1) === _e) {
              for (let A = k + 2; A < t.length; A++)
                if (((f = t.charCodeAt(A)), f === we)) A += 1;
                else if (f === _e && t.charCodeAt(A + 1) === Ue) {
                  k = A + 1;
                  break;
                }
            } else if (y === -1 && f === cn) y = l.length + k - g;
            ...
            else if ((f === ot || t.length - 1 === k) && m.length === 0) {
              (d = k - 1), (l += t.slice(g, k));
              break;
            } else
              (f === Rt || f === dn || f === ot) &&
        ...
        } else if (c === Ke && l.charCodeAt(0) === lt)
          (a = Ae(l)), i ? i.nodes.push(a) : r.push(a), (l = ""), (a = null);
        else if (c === Ke && p[p.length - 1] !== ")") {
          let m = at(l);
          if (!m)
            throw l.length === 0
          ...
          let m = e.pop() ?? null;
          m === null && i && r.push(i), (i = m), (l = ""), (a = null);
        } else if (c === st) (p += ")"), (l += "(");
        else if (c === Rt) {
          if (p[p.length - 1] !== ")") throw new Error("Missing opening (");
          (p = p.slice(0, -1)), (l += ")");
        } else {
          if (l.length === 0 && (c === xe || c === ae || c === De)) continue;
          l += String.fromCharCode(c);
        }
      }
    }
    if ((l.charCodeAt(0) === lt && r.push(Ae(l)), p.length > 0 && i)) {
      if (i.kind === "rule")
  ...
  function Pt(t, r) {
    return (Ut.get(r) ?? []).some((n) => t === n || t.startsWith(`${n}-`));
  }
  var ze = class {
    ...
    keysInNamespaces(r) {
      ...
      for (let e of r) {
        let i = `${e}-`;
        for (let a of this.values.keys())
          a.startsWith(i) &&
            a.indexOf("--", 2) === -1 &&
            (Pt(a, e) || n.push(a.slice(i.length)));
      }
      return n;
    }
    get(r) {
    ...
    clearNamespace(r, n) {
      ...
      e: for (let i of this.values.keys())
        if (i.startsWith(r)) {
          ...
          for (let a of e) if (i.startsWith(a)) continue e;
    ...
    resolve(r, n, e = 0) {
      ...
      return (e | a.options) & 1 ? a.value : this.#t(i);
    }
    resolveValue(r, n) {
      let e = this.#e(r, n);
    ...
    resolveWith(r, n, e = []) {
      ...
      for (let p of e) {
        let f = `${i}${p}`,
          d = this.values.get(f);
        d && (d.options & 1 ? (a[p] = d.value) : (a[p] = this.#t(f)));
      }
      let l = this.values.get(i);
      return l.options & 1 ? [l.value, a] : [this.#t(i), a];
    }
    namespace(r) {
      let n = new Map(),
        e = `${r}-`;
      for (let [i, a] of this.values)
        i === r
          ? n.set(null, a.value)
          : i.startsWith(`${e}-`)
          ? n.set(i.slice(r.length), a.value)
          : i.startsWith(e) && n.set(i.slice(e.length), a.value);
      return n;
    }
    addKeyframes(r) {
  ...
  function Q(t, r, n = null) {
    for (let e = 0; e < t.length; e++) {
      ...
      if (p === 2) return 2;
      if (p !== 1 && i.kind === "function" && Q(i.nodes, r, i) === 2) return 2;
    }
  }
  function H(t) {
    let r = "";
...
`
    ...
    for (let l = 0; l < t.length; l++) {
      ...
      switch (p) {
        ...
        case yn: {
          let f = mn(i, []);
          (i = ""), e ? e.nodes.push(f) : r.push(f), n.push(f), (e = f);
          break;
        }
        case hn: {
          let f = n.pop();
    ...
    return i.length > 0 && r.push(ct(i)), r;
  }
  function Fe(t) {
    let r = [];
    return (
  ...
  function M(t, r = []) {
    return t.charCodeAt(0) === wn ? Ae(t, r) : D(t, r);
  }
  function s(t, r, n = !1) {
  ...
  function U(t, r, n = [], e = {}) {
    for (let i = 0; i < t.length; i++) {
      let a = t[i],
        l = n[n.length - 1] ?? null;
      if (a.kind === "context") {
        if (U(a.nodes, r, n, { ...e, ...a.context }) === 2) return 2;
        continue;
      }
      n.push(a);
      let p = !1,
  ...
  function Ie(t, r, n = [], e = {}) {
    for (let i = 0; i < t.length; i++) {
      let a = t[i],
        l = n[n.length - 1] ?? null;
      if (a.kind === "rule" || a.kind === "at-rule")
        n.push(a), Ie(a.nodes, r, n, e), n.pop();
      else if (a.kind === "context") {
        Ie(a.nodes, r, n, { ...e, ...a.context });
        continue;
      }
      n.push(a),
        r(a, {
    ...
    function f(c, m, g = {}, y = 0) {
      if (c.kind === "declaration") {
        ...
        if (g.theme && c.property[0] === "-" && c.property[1] === "-") {
          ...
          g.keyframes || i.get(m).add(c);
        }
        if (c.value.includes("var("))
          if (g.theme && c.property[0] === "-" && c.property[1] === "-")
            for (let b of Fe(c.value)) p.get(b).add(c.property);
        ...
        let b = { ...c, nodes: [] };
        for (let k of c.nodes) f(k, b.nodes, g, y + 1);
        c.name === "@keyframes" && g.theme && a.add(b),
          (b.nodes.length > 0 ||
            b.name === "@layer" ||
            b.name === "@charset" ||
            b.name === "@custom-media" ||
    ...
    e: for (let [c, m] of i)
      for (let g of m) {
        ...
        if ((c.splice(b, 1), c.length === 0)) {
          let k = xn(d, (A) => A.kind === "rule" && A.nodes === c);
...
`;
        ...
        a += `${l}${e.selector} {
`;
        for (let p of e.nodes) a += r(p, i + 1);
        a += `${l}}
`;
...
`;
  ...
  function Bt(t, r, n, e = new Set()) {
    if (e.has(t) || (e.add(t), r.getOptions(t) & 24)) return !0;
    {
      let a = n.get(t) ?? [];
      for (let l of a) if (Bt(l, r, n, e)) return !0;
    }
    return !1;
  }
  var ft = [
    ...
    Me = ["anchor-size"],
    qt = new RegExp(`(${Me.join("|")})\\(`, "g");
  function Se(t) {
    return t.indexOf("(") !== -1 && ft.some((r) => t.includes(`${r}(`));
  }
  function Ht(t) {
    if (!ft.some((i) => t.includes(i))) return t;
    let r = !1;
    Me.some((i) => t.includes(i)) &&
      ((qt.lastIndex = 0),
      (t = t.replace(qt, (i, a) => ((r = !0), `$${Me.indexOf(a)}$(`))));
    let n = "",
      e = [];
    for (let i = 0; i < t.length; i++) {
      let a = t[i];
      if (a === "(") {
        ...
        e.unshift(!1);
        continue;
      } else if (a === ")") (n += a), e.shift();
      else if (a === "," && e[0]) {
        n += ", ";
        continue;
      } else {
        if (a === " " && e[0] && n[n.length - 1] === " ") continue;
        if ((a === "+" || a === "*" || a === "/" || a === "-") && e[0]) {
          let l = n.trimEnd(),
            p = l[l.length - 1];
          if (p === "+" || p === "*" || p === "/" || p === "-") {
    ...
    return r ? n.replace(/\$(\d+)\$/g, (i, a) => Me[a] ?? i) : n;
  }
  function ie(t) {
    if (t.indexOf("(") === -1) return ge(t);
    let r = I(t);
    return dt(r), (t = H(r)), (t = Ht(t)), t;
  }
  function ge(t, r = !1) {
    let n = "";
    for (let e = 0; e < t.length; e++) {
          ...
          if (
            ...
            for (let n = 0; n < r.nodes.length; n++) {
              if (n == 0 && r.nodes[n].kind === "word") {
                r.nodes[n].value = ge(r.nodes[n].value, !0);
                continue;
              }
              dt([r.nodes[n]]);
            }
  ...
  function* Zt(t, r) {
    ...
    e[e.length - 1] === "!"
      ...
      r.utilities.has(e, "static") &&
        !e.includes("[") &&
        (yield { kind: "static", root: e, variants: i, important: a, raw: t });
    let [l, p = null, f] = O(e, "/");
    if (f) return;
    let d = p === null ? null : pt(p);
    if (p !== null && d === null) return;
    if (l[0] === "[") {
      if (l[l.length - 1] !== "]") return;
      let m = l.charCodeAt(1);
      if (m !== Gt && !(m >= Yt && m <= Jt)) return;
      l = l.slice(1, -1);
      let g = l.indexOf(":");
    ...
    } else c = Xt(l, (m) => r.utilities.has(m, "functional"));
    for (let [m, g] of c) {
      let y = {
        kind: "functional",
        root: m,
      ...
      }
      {
        ...
        if (b !== -1) {
          ...
          let A = ie(g.slice(b + 1, -1)),
            x = "";
          for (let V = 0; V < A.length; V++) {
            let _ = A.charCodeAt(V);
            if (_ === Cn) {
              (x = A.slice(0, V)), (A = A.slice(V + 1));
              break;
            }
            if (!(_ === Gt || (_ >= Yt && _ <= Jt))) break;
          }
          if (A.length === 0 || A.trim().length === 0) continue;
          y.value = { kind: "arbitrary", dataType: x || null, value: A };
        } else {
          let A =
  ...
  function ce(t, r, n) {
    ...
    let e = t.indexOf("("),
      i = r.indexOf("("),
      a = e === -1 ? t.replace(/[\d.]+/g, "") : t.slice(0, e),
      l = i === -1 ? r.replace(/[\d.]+/g, "") : r.slice(0, i),
      p =
        (a === l ? 0 : a < l ? -1 : 1) ||
  ...
  var Sn = new Set([
    ...
    Nn = /^(rgba?|hsla?|hwb|color|(ok)?(lab|lch)|light-dark|color-mix)\(/i;
  function er(t) {
    return t.charCodeAt(0) === 35 || Nn.test(t) || Sn.has(t.toLowerCase());
  }
  var $n = {
    color: er,
    length: Be,
  ...
  function L(t, r) {
    ...
    for (let n of r) if ($n[n]?.(t)) return n;
    return null;
  }
  var Tn = /^url\(.*\)$/;
  function tr(t) {
  ...
  function Vn(t) {
    return O(t, " ").every(
      (r) => Be(r) || rr(r) || r === "thin" || r === "medium" || r === "thick"
    );
  }
  var En = /^(?:element|image|cross-fade|image-set)\(/,
    Rn = /^(repeating-)?(conic|linear|radial)-gradient\(/;
  function On(t) {
    let r = 0;
    for (let n of O(t, ","))
      if (!n.startsWith("var(")) {
  ...
  var te = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/,
    Dn = new RegExp(`^${te.source}$`);
  function rr(t) {
    return Dn.test(t) || Se(t);
  }
  var jn = new RegExp(`^${te.source}%$`);
  function mt(t) {
    return jn.test(t) || Se(t);
  }
  var zn = new RegExp(`^${te.source}s*/s*${te.source}$`);
  function Fn(t) {
    return zn.test(t) || Se(t);
  }
  var In = [
      "cm",
      "mm",
    ...
    Ln = new RegExp(`^${te.source}(${In.join("|")})$`);
  function Be(t) {
    return Ln.test(t) || Se(t);
  }
  function Mn(t) {
    let r = 0;
    for (let n of O(t, " ")) {
  ...
  function fe(t, r) {
    return O(t, ",")
      .map((e) => {
        ...
        let f = r(a ?? "currentcolor");
        return a !== null ? e.replace(a, f) : `${e} ${f}`;
      })
      .join(", ");
  }
  var Xn = /^-?[a-z][a-zA-Z0-9/%._-]*$/,
    ei = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/,
    ht = class {
      utilities = new F(() => []);
      completions = new Map();
  ...
  function W(t, r, n) {
    ...
    return e ? J(t, e) : qe(r.value) ? J(t, `${r.value}%`) : null;
  }
  function G(t, r, n) {
    let e = null;
  ...
  function lr(t) {
    ...
    function n(o, u) {
      ...
      r.suggest(o, () => {
        ...
        for (let E of u()) {
          ...
          let S = [...(E.values ?? []), ...w(E.valueThemeKeys ?? [])],
            C = [...(E.modifiers ?? []), ...w(E.modifierThemeKeys ?? [])];
    ...
    function e(o, u) {
      r.static(o, () =>
        u.map((h) => (typeof h == "function" ? h() : s(h[0], h[1])))
      );
    }
    function i(o, u) {
        ...
        return (v) => {
          ...
          if (v.value)
            if (v.value.kind === "arbitrary") {
              ...
              if (N === null && w && u.handleNegativeBareValue) {
                if (
          ...
          if (N !== null) return u.handle(w ? `calc(${N} * -1)` : N);
        };
      }
      u.supportsNegative && r.functional(`-${o}`, h({ negative: !0 })),
        r.functional(o, h({ negative: !1 })),
        n(o, () => [
          {
    ...
    function l(
      ...
      u,
      h,
      { supportsNegative: w = !1, supportsFractions: v = !1 } = {}
    ) {
      w && r.static(`-${o}-px`, () => h("-1px")),
        r.static(`${o}-px`, () => h("1px")),
        i(o, {
          themeKeys: u,
          supportsFractions: v,
    ...
    e("isolate", [["isolation", "isolate"]]),
      ...
      n("order", () => [
        {
          supportsNegative: !0,
          values: Array.from({ length: 12 }, (o, u) => `${u + 1}`),
      ...
      i("col", {
        ...
        handle: (o) => [s("grid-column", o)],
      }),
      e("col-span-full", [["grid-column", "1 / -1"]]),
      i("col-span", {
        handleBareValue: ({ value: o }) => (T(o) ? o : null),
        handle: (o) => [s("grid-column", `span ${o} / span ${o}`)],
      }),
      ...
      i("col-start", {
        ...
        handle: (o) => [s("grid-column-start", o)],
      }),
      ...
      n("col-start", () => [
        {
          supportsNegative: !0,
          values: Array.from({ length: 13 }, (o, u) => `${u + 1}`),
      ...
      i("row", {
        ...
        handleBareValue: ({ value: o }) => (T(o) ? o : null),
        themeKeys: ["--grid-row"],
        handle: (o) => [s("grid-row", o)],
      }),
      e("row-span-full", [["grid-row", "1 / -1"]]),
      i("row-span", {
        themeKeys: [],
        handleBareValue: ({ value: o }) => (T(o) ? o : null),
        handle: (o) => [s("grid-row", `span ${o} / span ${o}`)],
      }),
    ...
    e("box-border", [["box-sizing", "border-box"]]),
      ...
      i("aspect", {
        ...
        handleBareValue: ({ fraction: o }) => {
          ...
          let [u, h] = O(o, "/");
          return !T(u) || !T(h) ? null : o;
        },
        handle: (o) => [s("aspect-ratio", o)],
      });
    for (let [o, u] of [
      ["auto", "auto"],
      ["full", "100%"],
      ...
      e(`size-${o}`, [
        ...
        e(`w-${o}`, [["width", u]]),
        e(`h-${o}`, [["height", u]]),
        e(`min-w-${o}`, [["min-width", u]]),
        e(`min-h-${o}`, [["min-height", u]]),
        o !== "auto" &&
          (e(`max-w-${o}`, [["max-width", u]]),
          e(`max-h-${o}`, [["max-height", u]]));
    e("w-screen", [["width", "100vw"]]),
      ...
      l(
        "size",
        ["--size", "--spacing"],
        (o) => [s("--tw-sort", "size"), s("width", o), s("height", o)],
        { supportsFractions: !0 }
      );
    for (let [o, u, h] of [
      ...
      l(o, u, (w) => [s(h, w)], { supportsFractions: !0 });
    r.static("container", () => {
      let o = [...t.namespace("--breakpoint").values()];
      o.sort((h, w) => ce(h, w, "asc"));
      let u = [s("--tw-sort", "--tw-container-component"), s("width", "100%")];
      for (let h of o)
        u.push(P("@media", `(width >= ${h})`, [s("max-width", h)]));
      return u;
    }),
      ...
      r.functional("flex", (o) => {
        if (o.value) {
          if (o.value.kind === "arbitrary")
            return o.modifier ? void 0 : [s("flex", o.value.value)];
          if (o.value.fraction) {
            let [u, h] = O(o.value.fraction, "/");
            return !T(u) || !T(h)
              ? void 0
              : [s("flex", `calc(${o.value.fraction} * 100%)`)];
          }
          if (T(o.value.value))
            return o.modifier ? void 0 : [s("flex", o.value.value)];
        }
      ...
      i("shrink", {
        defaultValue: "1",
        handleBareValue: ({ value: o }) => (T(o) ? o : null),
        handle: (o) => [s("flex-shrink", o)],
      }),
      i("grow", {
        defaultValue: "1",
        handleBareValue: ({ value: o }) => (T(o) ? o : null),
        handle: (o) => [s("flex-grow", o)],
      }),
      n("shrink", () => [
    ...
    l("border-spacing", ["--border-spacing", "--spacing"], (o) => [
      p(),
      s("--tw-border-spacing-x", o),
      s("--tw-border-spacing-y", o),
      s(
        "border-spacing",
    ...
    for (let o of ["x", "y", "z"])
      i(`scale-${o}`, {
        supportsNegative: !0,
        themeKeys: ["--scale"],
        handleBareValue: ({ value: u }) => (T(u) ? `${u}%` : null),
        handle: (u) => [
          d(),
          s(`--tw-scale-${o}`, u),
          s(
    ...
    function m({ negative: o }) {
      return (u) => {
        ...
        if (u.value.kind === "arbitrary") {
          h = u.value.value;
          let w = u.value.dataType ?? L(h, ["angle", "vector"]);
          if (w === "vector") return [s("rotate", `${h} var(--tw-rotate)`)];
          if (w !== "angle") return [s("rotate", h)];
        } else if (
          ((h = t.resolve(u.value.value, ["--rotate"])),
          !h && T(u.value.value) && (h = `${u.value.value}deg`),
          !h)
        )
          return;
        return [s("rotate", o ? `calc(${h} * -1)` : h)];
      };
    }
      ...
      ]);
    {
      ...
      for (let h of ["x", "y", "z"])
        i(`rotate-${h}`, {
          ...
          handle: (w) => [
            u(),
            s(`--tw-rotate-${h}`, `rotate${h.toUpperCase()}(${w})`),
            s("transform", o),
          ],
        }),
          n(`rotate-${h}`, () => [
      ...
      i("skew", {
        ...
        r.functional("transform", (h) => {
          ...
          if (
            ...
            return [u(), s("transform", w)];
        }),
        n("transform", () => [{ hasDefaultValue: !0 }]),
        e("transform-cpu", [["transform", o]]),
        e("transform-gpu", [["transform", `translateZ(0) ${o}`]]),
    ...
    for (let o of [
      ...
      e(`cursor-${o}`, [["cursor", o]]);
    i("cursor", { themeKeys: ["--cursor"], handle: (o) => [s("cursor", o)] });
    for (let o of ["auto", "none", "manipulation"])
      e(`touch-${o}`, [["touch-action", o]]);
    let g = () => K([$("--tw-pan-x"), $("--tw-pan-y"), $("--tw-pinch-zoom")]);
    ...
    let y = () => K([$("--tw-scroll-snap-strictness", "proximity", "*")]);
    for (let o of ["x", "y", "both"])
      e(`snap-${o}`, [
        y,
        ["scroll-snap-type", `${o} var(--tw-scroll-snap-strictness)`],
      ]);
    ...
    for (let [o, u] of [
      ...
      l(o, ["--scroll-margin", "--spacing"], (h) => [s(u, h)], {
        supportsNegative: !0,
      });
    for (let [o, u] of [
      ...
      l(o, ["--scroll-padding", "--spacing"], (h) => [s(u, h)]);
    ...
    e("grid-flow-row", [["grid-auto-flow", "row"]]),
      ...
      i("auto-cols", {
        ...
        handle: (o) => [s("grid-auto-columns", o)],
      }),
      ...
      i("grid-cols", {
        ...
        handleBareValue: ({ value: o }) =>
          gt(o) ? `repeat(${o}, minmax(0, 1fr))` : null,
        handle: (o) => [s("grid-template-columns", o)],
      }),
      ...
      i("grid-rows", {
        ...
        handleBareValue: ({ value: o }) =>
          gt(o) ? `repeat(${o}, minmax(0, 1fr))` : null,
        handle: (o) => [s("grid-template-rows", o)],
      }),
      n("grid-cols", () => [
        {
          values: Array.from({ length: 12 }, (o, u) => `${u + 1}`),
      ...
      l("gap", ["--gap", "--spacing"], (o) => [s("gap", o)]),
      l("gap-x", ["--gap", "--spacing"], (o) => [s("column-gap", o)]),
      l("gap-y", ["--gap", "--spacing"], (o) => [s("row-gap", o)]),
      l(
        "space-x",
        ["--space", "--spacing"],
        (o) => [
          K([$("--tw-space-x-reverse", "0")]),
          D(":where(& > :not(:last-child))", [
            s("--tw-sort", "row-gap"),
            s("--tw-space-x-reverse", "0"),
            s("margin-inline-start", `calc(${o} * var(--tw-space-x-reverse))`),
            s(
              "margin-inline-end",
              `calc(${o} * calc(1 - var(--tw-space-x-reverse)))`
            ),
          ]),
        ],
        { supportsNegative: !0 }
      ...
      l(
        ...
        ["--space", "--spacing"],
        (o) => [
          K([$("--tw-space-y-reverse", "0")]),
          D(":where(& > :not(:last-child))", [
            s("--tw-sort", "column-gap"),
            s("--tw-space-y-reverse", "0"),
            s("margin-block-start", `calc(${o} * var(--tw-space-y-reverse))`),
            s(
              "margin-block-end",
              `calc(${o} * calc(1 - var(--tw-space-y-reverse)))`
            ),
          ]),
        ],
        { supportsNegative: !0 }
      ...
      a("accent", {
        ...
        handle: (o) => [s("accent-color", o)],
      }),
      a("caret", {
        themeKeys: ["--caret-color", "--color"],
        handle: (o) => [s("caret-color", o)],
      }),
      a("divide", {
    ...
    for (let o of ["auto", "hidden", "clip", "visible", "scroll"])
      e(`overflow-${o}`, [["overflow", o]]),
        e(`overflow-x-${o}`, [["overflow-x", o]]),
        e(`overflow-y-${o}`, [["overflow-y", o]]);
    for (let o of ["auto", "contain", "none"])
      e(`overscroll-${o}`, [["overscroll-behavior", o]]),
        e(`overscroll-x-${o}`, [["overscroll-behavior-x", o]]),
        e(`overscroll-y-${o}`, [["overscroll-behavior-y", o]]);
    ...
    for (let [o, u] of [
      ...
      e(
        ...
        i(o, { themeKeys: ["--radius"], handle: (h) => u.map((w) => s(w, h)) });
    e("border-solid", [
      ...
      ]);
    {
        ...
        r.functional(h, (v) => {
          ...
          if (v.value.kind === "arbitrary") {
            ...
            switch (
              ...
              default:
                return (
                  (N = W(N, v.modifier, t)), N === null ? void 0 : w.color(N)
                );
            }
          }
          {
          ...
          }
          {
            ...
            if (T(v.value.value)) {
              let E = w.width(`${v.value.value}px`);
              return E ? [o(), ...E] : void 0;
            }
          }
        }),
      ...
      var A = u;
      let o = () => K([$("--tw-border-style", "solid")]);
      u("border", {
        width: (h) => [
          s("border-style", "var(--tw-border-style)"),
          s("border-width", h),
        ],
        color: (h) => [s("border-color", h)],
      }),
        u("border-x", {
          width: (h) => [
            s("border-inline-style", "var(--tw-border-style)"),
            s("border-inline-width", h),
          ],
          color: (h) => [s("border-inline-color", h)],
        }),
        u("border-y", {
          width: (h) => [
            s("border-block-style", "var(--tw-border-style)"),
            s("border-block-width", h),
          ],
          color: (h) => [s("border-block-color", h)],
        }),
        u("border-s", {
          width: (h) => [
            s("border-inline-start-style", "var(--tw-border-style)"),
            s("border-inline-start-width", h),
          ],
          color: (h) => [s("border-inline-start-color", h)],
        }),
        u("border-e", {
          width: (h) => [
            s("border-inline-end-style", "var(--tw-border-style)"),
            s("border-inline-end-width", h),
          ],
          color: (h) => [s("border-inline-end-color", h)],
        }),
        u("border-t", {
          width: (h) => [
            s("border-top-style", "var(--tw-border-style)"),
            s("border-top-width", h),
          ],
          color: (h) => [s("border-top-color", h)],
        }),
        u("border-r", {
          width: (h) => [
            s("border-right-style", "var(--tw-border-style)"),
            s("border-right-width", h),
          ],
          color: (h) => [s("border-right-color", h)],
        }),
        u("border-b", {
          width: (h) => [
            s("border-bottom-style", "var(--tw-border-style)"),
            s("border-bottom-width", h),
          ],
          color: (h) => [s("border-bottom-color", h)],
        }),
        u("border-l", {
          width: (h) => [
            s("border-left-style", "var(--tw-border-style)"),
            s("border-left-width", h),
          ],
          color: (h) => [s("border-left-color", h)],
        }),
        i("divide-x", {
        ...
        i("divide-y", {
          ...
          handle: (h) => [
            ...
            D(":where(& > :not(:last-child))", [
              ...
              s("border-bottom-style", "var(--tw-border-style)"),
              s("border-top-style", "var(--tw-border-style)"),
              s("border-top-width", `calc(${h} * var(--tw-divide-y-reverse))`),
              s(
                "border-bottom-width",
      ...
      e("bg-none", [["background-image", "none"]]);
    {
      let h = function (N) {
        ...
        w = function ({ negative: N }) {
          return (E) => {
            ...
            if (E.value.kind === "arbitrary") {
              ...
              let z = E.value.value;
              switch (E.value.dataType ?? L(z, ["angle"])) {
                case "angle":
                  return (
                    (z = N ? `calc(${z} * -1)` : `${z}`),
                    [
                      s("--tw-gradient-position", z),
                      s(
                        "background-image",
            ...
            else if (T(S)) S = N ? `calc(${S}deg * -1)` : `${S}deg`;
            else return;
            let C = h(E.modifier);
            return [
              s("--tw-gradient-position", `${S} ${C}`),
              s(
                "background-image",
        ...
        v = function ({ negative: N }) {
          return (E) => {
            ...
            if (T(C))
              return (
                (C = N ? `calc(${C}deg * -1)` : `${C}deg`),
                [
                  s("--tw-gradient-position", `from ${C} ${S}`),
                  s(
                    "background-image",
                    "conic-gradient(var(--tw-gradient-stops))"
                  ),
      ...
      r.functional("-bg-linear", w({ negative: !0 })),
        ...
        n("bg-radial", () => [{ hasDefaultValue: !0, modifiers: o }]);
    }
    r.functional("bg", (o) => {
      if (o.value) {
        if (o.value.kind === "arbitrary") {
          ...
          switch (
            ...
            case "percentage":
            case "position":
              return o.modifier ? void 0 : [s("background-position", u)];
            case "bg-size":
            case "length":
            case "size":
              return o.modifier ? void 0 : [s("background-size", u)];
            case "image":
            case "url":
              return o.modifier ? void 0 : [s("background-image", u)];
            default:
              return (
                (u = W(u, o.modifier, t)),
                u === null ? void 0 : [s("background-color", u)]
              );
          }
        }
        {
          let u = G(o, t, ["--background-color", "--color"]);
          if (u) return [s("background-color", u)];
        }
        {
          if (o.modifier) return;
          let u = t.resolve(o.value.value, ["--background-image"]);
          if (u) return [s("background-image", u)];
        }
      }
    }),
      n("bg", () => [
        {
          ...
          modifiers: Array.from({ length: 21 }, (o, u) => `${u * 5}`),
        },
      ...
      r.functional(o, (h) => {
        if (h.value) {
          if (h.value.kind === "arbitrary") {
            ...
            switch (
              h.value.dataType ??
              L(w, ["color", "length", "percentage"])
            ) {
              case "length":
              case "percentage":
                return h.modifier ? void 0 : u.position(w);
              default:
                return (
                  (w = W(w, h.modifier, t)), w === null ? void 0 : u.color(w)
                );
            }
          }
          {
    ...
    k("from", {
      color: (o) => [
        ...
        s("--tw-gradient-from", o),
        s(
          "--tw-gradient-stops",
          "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))"
        ),
      ],
      position: (o) => [b(), s("--tw-gradient-from-position", o)],
    }),
      ...
      k("via", {
        ...
        position: (o) => [b(), s("--tw-gradient-via-position", o)],
      }),
      k("to", {
        color: (o) => [
          b(),
        ...
        position: (o) => [b(), s("--tw-gradient-to-position", o)],
      }),
    ...
    for (let o of [
      ...
      e(`bg-blend-${o}`, [["background-blend-mode", o]]),
        e(`mix-blend-${o}`, [["mix-blend-mode", o]]);
    e("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]),
      ...
      r.functional("fill", (o) => {
        ...
        if (o.value.kind === "arbitrary") {
          ...
          return h === null ? void 0 : [s("fill", h)];
        }
        let u = G(o, t, ["--fill", "--color"]);
        if (u) return [s("fill", u)];
      }),
      n("fill", () => [
        {
          values: ["current", "inherit", "transparent"],
      ...
      r.functional("stroke", (o) => {
        if (o.value) {
          if (o.value.kind === "arbitrary") {
            ...
            switch (
              o.value.dataType ??
              L(u, ["color", "number", "length", "percentage"])
            ) {
              case "number":
              case "length":
              case "percentage":
                return o.modifier ? void 0 : [s("stroke-width", u)];
              default:
                return (
                  (u = W(o.value.value, o.modifier, t)),
                  u === null ? void 0 : [s("stroke", u)]
                );
            }
          }
          {
            let u = G(o, t, ["--stroke", "--color"]);
            if (u) return [s("stroke", u)];
          }
          {
            let u = t.resolve(o.value.value, ["--stroke-width"]);
            if (u) return [s("stroke-width", u)];
            if (T(o.value.value)) return [s("stroke-width", o.value.value)];
          }
        }
      }),
      n("stroke", () => [
    ...
    e("text-left", [["text-align", "left"]]),
      ...
      i("align", { themeKeys: [], handle: (o) => [s("vertical-align", o)] }),
      r.functional("font", (o) => {
        if (!(!o.value || o.modifier)) {
          if (o.value.kind === "arbitrary") {
            ...
            switch (
              o.value.dataType ??
              L(u, ["number", "generic-name", "family-name"])
            ) {
              case "generic-name":
              case "family-name":
                return [s("font-family", u)];
              default:
                return [
                  K([$("--tw-font-weight")]),
                  s("--tw-font-weight", u),
          ...
          }
          {
            ...
            if (u) {
              ...
              return [
                s("font-family", h),
                s("font-feature-settings", w["--font-feature-settings"]),
                s("font-variation-settings", w["--font-variation-settings"]),
              ];
            }
          }
          {
            let u = t.resolve(o.value.value, ["--font-weight"]);
            if (u)
              return [
                K([$("--tw-font-weight")]),
                s("--tw-font-weight", u),
      ...
      i("font-stretch", {
        handleBareValue: ({ value: o }) => {
          ...
          return !T(u) || Number.isNaN(u) || u < 50 || u > 200 ? null : o;
        },
        handle: (o) => [s("font-stretch", o)],
      }),
      n("font-stretch", () => [
        {
          values: [
      ...
      r.functional("decoration", (o) => {
        if (o.value) {
          if (o.value.kind === "arbitrary") {
            ...
            switch (
              o.value.dataType ??
              L(u, ["color", "length", "percentage"])
            ) {
              case "length":
              case "percentage":
                return o.modifier
                  ? void 0
                  : [s("text-decoration-thickness", u)];
              default:
                return (
                  (u = W(u, o.modifier, t)),
                  u === null ? void 0 : [s("text-decoration-color", u)]
                );
            }
          }
          {
            let u = t.resolve(o.value.value, ["--text-decoration-thickness"]);
            if (u)
              return o.modifier ? void 0 : [s("text-decoration-thickness", u)];
            if (T(o.value.value))
              return o.modifier
                ? void 0
                : [s("text-decoration-thickness", `${o.value.value}px`)];
          }
          {
            let u = G(o, t, ["--text-decoration-color", "--color"]);
            if (u) return [s("text-decoration-color", u)];
          }
        }
      }),
      n("decoration", () => [
      ...
      });
    {
      ...
      r.functional("filter", (v) => {
        if (!v.modifier) {
          if (v.value === null) return [h(), s("filter", o)];
          if (v.value.kind === "arbitrary") return [s("filter", v.value.value)];
        ...
        r.functional("backdrop-filter", (v) => {
          if (!v.modifier) {
            if (v.value === null)
              return [
                w(),
                s("-webkit-backdrop-filter", u),
                s("backdrop-filter", u),
              ];
            if (v.value.kind === "arbitrary")
              return [
                s("-webkit-backdrop-filter", v.value.value),
                s("backdrop-filter", v.value.value),
              ];
            switch (v.value.value) {
              case "none":
                return [
        ...
        i("blur", {
          themeKeys: ["--blur"],
          handle: (v) => [h(), s("--tw-blur", `blur(${v})`), s("filter", o)],
        }),
        e("blur-none", [h, ["--tw-blur", " "], ["filter", o]]),
        i("backdrop-blur", {
          themeKeys: ["--backdrop-blur", "--blur"],
          handle: (v) => [
            w(),
            s("--tw-backdrop-blur", `blur(${v})`),
            s("-webkit-backdrop-filter", u),
            s("backdrop-filter", u),
          ],
        }),
        ...
        i("brightness", {
          ...
          handleBareValue: ({ value: v }) => (T(v) ? `${v}%` : null),
          handle: (v) => [
            h(),
            s("--tw-brightness", `brightness(${v})`),
            s("filter", o),
          ],
        }),
        i("backdrop-brightness", {
          ...
          handle: (v) => [
            w(),
            s("--tw-backdrop-brightness", `brightness(${v})`),
            s("-webkit-backdrop-filter", u),
            s("backdrop-filter", u),
          ],
        }),
        ...
        i("backdrop-contrast", {
          ...
          handle: (v) => [
            w(),
            s("--tw-backdrop-contrast", `contrast(${v})`),
            s("-webkit-backdrop-filter", u),
            s("backdrop-filter", u),
          ],
        }),
        ...
        i("backdrop-grayscale", {
          ...
          handle: (v) => [
            w(),
            s("--tw-backdrop-grayscale", `grayscale(${v})`),
            s("-webkit-backdrop-filter", u),
            s("backdrop-filter", u),
          ],
        }),
        ...
        i("hue-rotate", {
          ...
          handleBareValue: ({ value: v }) => (T(v) ? `${v}deg` : null),
          handle: (v) => [
            h(),
            s("--tw-hue-rotate", `hue-rotate(${v})`),
            s("filter", o),
          ],
        }),
        i("backdrop-hue-rotate", {
          ...
          handle: (v) => [
            w(),
            s("--tw-backdrop-hue-rotate", `hue-rotate(${v})`),
            s("-webkit-backdrop-filter", u),
            s("backdrop-filter", u),
          ],
        }),
        ...
        i("backdrop-saturate", {
          ...
          handle: (v) => [
            w(),
            s("--tw-backdrop-saturate", `saturate(${v})`),
            s("-webkit-backdrop-filter", u),
            s("backdrop-filter", u),
          ],
        }),
        ...
        i("sepia", {
          ...
          handleBareValue: ({ value: v }) => (T(v) ? `${v}%` : null),
          defaultValue: "100%",
          handle: (v) => [h(), s("--tw-sepia", `sepia(${v})`), s("filter", o)],
        }),
        i("backdrop-sepia", {
        ...
        e("drop-shadow-none", [h, ["--tw-drop-shadow", " "], ["filter", o]]),
        i("drop-shadow", {
        ...
        i("backdrop-opacity", {
          ...
          handleBareValue: ({ value: v }) => (qe(v) ? `${v}%` : null),
          handle: (v) => [
            w(),
            s("--tw-backdrop-opacity", `opacity(${v})`),
            s("-webkit-backdrop-filter", u),
            s("backdrop-filter", u),
          ],
        }),
    ...
    }
    {
      ...
      e("transition-none", [["transition-property", "none"]]),
        ...
        i("transition", {
          ...
          handle: (h) => [
            s("transition-property", h),
            s("transition-timing-function", o),
          ...
          r.functional("duration", (w) => {
            ...
            if (
              (w.value.kind === "arbitrary"
                ? (v = w.value.value)
                : ((v = t.resolve(w.value.fraction ?? w.value.value, [
                    "--transition-duration",
                  ])),
                  v === null && T(w.value.value) && (v = `${w.value.value}ms`)),
              v !== null)
            )
              return [h(), s("--tw-duration", v), s("transition-duration", v)];
          });
      }
      n("delay", () => [
        {
    ...
    {
      let o = () => K([$("--tw-ease")]);
      e("ease-initial", [o, ["--tw-ease", "initial"]]),
        e("ease-linear", [
          o,
          ["--tw-ease", "linear"],
        ...
        i("ease", {
          ...
          handle: (u) => [
            o(),
            s("--tw-ease", u),
            s("transition-timing-function", u),
          ],
        });
    }
    e("will-change-auto", [["will-change", "auto"]]),
      ...
      i("will-change", { themeKeys: [], handle: (o) => [s("will-change", o)] }),
      e("content-none", [
        ["--tw-content", "none"],
        ["content", "none"],
      ]),
      ...
      });
    {
      ...
      e("contain-none", [["contain", "none"]]),
        ...
        e("contain-size", [u, ["--tw-contain-size", "size"], ["contain", o]]),
        ...
        i("contain", { themeKeys: [], handle: (h) => [s("contain", h)] });
    }
    ...
    {
      let o = () => K([$("--tw-outline-style", "solid")]);
      r.static("outline-hidden", () => [
        ...
        r.functional("outline", (u) => {
          ...
          if (u.value.kind === "arbitrary") {
            ...
            switch (
              u.value.dataType ??
              L(h, ["color", "length", "number", "percentage"])
            ) {
              case "length":
              case "number":
              case "percentage":
              ...
              default:
                return (
                  (h = W(h, u.modifier, t)),
                  h === null ? void 0 : [s("outline-color", h)]
                );
            }
          }
          {
            let h = G(u, t, ["--outline-color", "--color"]);
            if (h) return [s("outline-color", h)];
          }
          {
            if (u.modifier) return;
            ...
            if (T(u.value.value))
              return [
                o(),
                s("outline-style", "var(--tw-outline-style)"),
                s("outline-width", `${u.value.value}px`),
              ];
          }
        }),
        n("outline", () => [
        ...
        i("outline-offset", {
          ...
          handleBareValue: ({ value: u }) => (T(u) ? `${u}px` : null),
          handle: (u) => [s("outline-offset", u)],
        }),
        n("outline-offset", () => [
          {
            supportsNegative: !0,
    ...
    i("opacity", {
      themeKeys: ["--opacity"],
      handleBareValue: ({ value: o }) => (qe(o) ? `${o}%` : null),
      handle: (o) => [s("opacity", o)],
    }),
      n("opacity", () => [
        {
          values: Array.from({ length: 21 }, (o, u) => `${u * 5}`),
      ...
      i("underline-offset", {
        ...
        handle: (o) => [s("text-underline-offset", o)],
      }),
      n("underline-offset", () => [
        {
          supportsNegative: !0,
          ...
          if (o.value.kind === "arbitrary") {
            ...
            switch (
              ...
              case "relative-size": {
                if (o.modifier) {
                  let w =
                    o.modifier.kind === "arbitrary"
                      ? o.modifier.value
                      : t.resolve(o.modifier.value, ["--leading"]);
                  if (!w && he(o.modifier.value)) {
                    let v = t.resolve(null, ["--spacing"]);
                    if (!v) return null;
                    w = `calc(${v} * ${o.modifier.value})`;
                  }
                  return (
                    !w && o.modifier.value === "none" && (w = "1"),
                    w ? [s("font-size", u), s("line-height", w)] : null
                  );
                }
                return [s("font-size", u)];
              }
              default:
                return (
                  (u = W(u, o.modifier, t)),
                  u === null ? void 0 : [s("color", u)]
                );
            }
          }
          {
            let u = G(o, t, ["--text-color", "--color"]);
            if (u) return [s("color", u)];
          }
          {
            let u = t.resolveWith(
              o.value.value,
            ...
            if (u) {
              let [h, w = {}] = Array.isArray(u) ? u : [u];
              if (o.modifier) {
                let v =
                  o.modifier.kind === "arbitrary"
                    ? o.modifier.value
                    : t.resolve(o.modifier.value, ["--leading"]);
                if (!v && he(o.modifier.value)) {
                  let E = t.resolve(null, ["--spacing"]);
                  if (!E) return null;
                  v = `calc(${E} * ${o.modifier.value})`;
                }
                if ((!v && o.modifier.value === "none" && (v = "1"), !v))
                  return null;
                let N = [s("font-size", h)];
                return v && N.push(s("line-height", v)), N;
              }
              return typeof w == "string"
                ? [s("font-size", h), s("line-height", w)]
                : [
                    s("font-size", h),
                    s(
                      "line-height",
    ...
    {
      let v = function (S) {
          return `var(--tw-ring-inset,) 0 0 0 calc(${S} + var(--tw-ring-offset-width)) var(--tw-ring-color, ${w})`;
        },
        N = function (S) {
      ...
      e("shadow-initial", [h, ["--tw-shadow-color", "initial"]]),
        r.functional("shadow", (S) => {
          ...
          if (S.value.kind === "arbitrary") {
            let C = S.value.value;
            switch (S.value.dataType ?? L(C, ["color"])) {
              case "color":
                return (
                  (C = W(C, S.modifier, t)),
                  C === null ? void 0 : [h(), s("--tw-shadow-color", C)]
                );
              default:
                return [
                  h(),
                  s(
                    "--tw-shadow",
                    fe(C, (Pe) => `var(--tw-shadow-color, ${Pe})`)
                  ),
                  s("box-shadow", o),
                ];
            }
          ...
          switch (S.value.value) {
            case "none":
              return S.modifier
                ? void 0
                : [h(), s("--tw-shadow", u), s("box-shadow", o)];
          }
          {
          ...
          }
          {
            ...
            if (C) return [h(), s("--tw-shadow-color", C)];
          }
        }),
        n("shadow", () => [
          {
        ...
        r.functional("inset-shadow", (S) => {
          if (!S.value) {
            ...
            return C === null
              ...
              : [
                  ...
                  s(
                    "--tw-inset-shadow",
                    fe(C, (z) => `var(--tw-inset-shadow-color, ${z})`)
                  ),
                  s("box-shadow", o),
                ];
          }
          if (S.value.kind === "arbitrary") {
            ...
            switch (S.value.dataType ?? L(C, ["color"])) {
              case "color":
                return (
                  (C = W(C, S.modifier, t)),
                  C === null ? void 0 : [h(), s("--tw-inset-shadow-color", C)]
                );
              default:
                return [
                  h(),
                  s(
                    ...
                    `inset ${fe(
                      C,
                      (Pe) => `var(--tw-inset-shadow-color, ${Pe})`
                    )}`
                  ),
                  s("box-shadow", o),
                ];
          ...
          switch (S.value.value) {
            case "none":
              return S.modifier
                ? void 0
                : [h(), s("--tw-inset-shadow", u), s("box-shadow", o)];
          }
          {
          ...
          {
            let C = G(S, t, ["--box-shadow-color", "--color"]);
            if (C) return [h(), s("--tw-inset-shadow-color", C)];
          }
        }),
        n("inset-shadow", () => [
          {
      ...
      r.functional("ring", (S) => {
        if (!S.value) {
          ...
          return [h(), s("--tw-ring-shadow", v(C)), s("box-shadow", o)];
        }
        if (S.value.kind === "arbitrary") {
          let C = S.value.value;
          switch (S.value.dataType ?? L(C, ["color", "length"])) {
            case "length":
              return S.modifier
                ? void 0
                : [h(), s("--tw-ring-shadow", v(C)), s("box-shadow", o)];
            default:
              return (
                (C = W(C, S.modifier, t)),
                C === null ? void 0 : [s("--tw-ring-color", C)]
              );
          }
        }
        {
          let C = G(S, t, ["--ring-color", "--color"]);
          if (C) return [s("--tw-ring-color", C)];
        }
        {
          if (S.modifier) return;
          let C = t.resolve(S.value.value, ["--ring-width"]);
          if ((C === null && T(S.value.value) && (C = `${S.value.value}px`), C))
            return [h(), s("--tw-ring-shadow", v(C)), s("box-shadow", o)];
        }
      }),
        n("ring", () => [
            ...
            switch (S.value.dataType ?? L(C, ["color", "length"])) {
              case "length":
                return S.modifier
                  ...
                  : [
                      h(),
                      s("--tw-inset-ring-shadow", N(C)),
                      s("box-shadow", o),
                    ];
              default:
                return (
                  (C = W(C, S.modifier, t)),
                  C === null ? void 0 : [s("--tw-inset-ring-color", C)]
                );
            }
          }
          {
            let C = G(S, t, ["--ring-color", "--color"]);
            if (C) return [s("--tw-inset-ring-color", C)];
          }
          {
            if (S.modifier) return;
            let C = t.resolve(S.value.value, ["--ring-width"]);
            if (
              (C === null && T(S.value.value) && (C = `${S.value.value}px`), C)
            )
              return [
                h(),
                s("--tw-inset-ring-shadow", N(C)),
            ...
            switch (S.value.dataType ?? L(C, ["color", "length"])) {
              case "length":
                return S.modifier
                  ? void 0
                  : [
                      s("--tw-ring-offset-width", C),
                      s("--tw-ring-offset-shadow", E),
                    ];
              default:
                return (
                  (C = W(C, S.modifier, t)),
                  C === null ? void 0 : [s("--tw-ring-offset-color", C)]
                );
            }
          }
          {
            ...
            if (T(S.value.value))
              return S.modifier
                ? void 0
                : [
                    s("--tw-ring-offset-width", `${S.value.value}px`),
                    s("--tw-ring-offset-shadow", E),
                  ];
          }
          {
            let C = G(S, t, ["--ring-offset-color", "--color"]);
            if (C) return [s("--tw-ring-offset-color", C)];
          }
        }
      });
    }
    return (
      ...
      r.functional("@container", (o) => {
        ...
        if (
          (o.value === null
            ? (u = "inline-size")
            : o.value.kind === "arbitrary"
            ? (u = o.value.value)
            : o.value.kind === "named" &&
              o.value.value === "normal" &&
              (u = "normal"),
          u !== null)
        )
          return o.modifier
            ? [s("container-type", u), s("container-name", o.modifier.value)]
            : [s("container-type", u)];
      }),
      n("@container", () => [
            ...
            Q(l, (p) => {
              ...
              for (let d of p.nodes)
                if (
                  ...
                  p.value === "--value"
                    ? e.add(c)
                    : p.value === "--modifier" && i.add(c);
                }
            }),
              (a.value = H(l));
          }),
            n.utilities.functional(r.slice(0, -2), (a) => {
              ...
              if (b)
                for (let [k, A] of y) {
                  let x = A.nodes.indexOf(k);
                  x !== -1 && A.nodes.splice(x, 1);
                }
              return l.nodes;
            }),
  ...
  function or(t, r, n) {
    for (let e of r.nodes)
      if (
        ...
        if (i.endsWith("-*")) {
          i = i.slice(0, -2);
          let a = n.theme.resolve(t.value, [i]);
          if (a) return { nodes: I(a) };
        } else {
          let a = i.split("-*");
          if (a.length <= 1) continue;
          let l = [a.shift()],
            p = n.theme.resolveWith(t.value, l, a);
          if (p) {
            let [, f = {}] = p;
            {
              let d = f[a.pop()];
              if (d) return { nodes: I(d) };
            }
          }
        }
        ...
        if (a === "ratio") {
          ...
          if (a === "number" && !he(i)) continue;
          if (a === "percentage" && !T(i.slice(0, -1))) continue;
        }
        return { nodes: I(i), ratio: a === "ratio" };
      } else if (
        t.kind === "arbitrary" &&
        e.kind === "word" &&
        e.value[0] === "[" &&
        ...
        if (i === "*") return { nodes: I(t.value) };
        if ("dataType" in t && t.dataType && t.dataType !== i) continue;
        if ("dataType" in t && t.dataType) return { nodes: I(t.value) };
        if (L(t.value, [i]) !== null) return { nodes: I(t.value) };
      }
  }
  var bt = { "--alpha": ti, "--spacing": ri, "--theme": ni, theme: ii };
  function ti(t, r, n, ...e) {
    let [i, a] = O(n, "/").map((l) => l.trim());
    if (!i || !a)
      throw new Error(
  ...
  function ni(t, r, n, ...e) {
    ...
    let i = !1;
    n.endsWith(" inline") && ((i = !0), (n = n.slice(0, -7))),
      r.kind === "at-rule" && (i = !0);
    let a = t.resolveThemeValue(n, i);
    if (!a) {
      if (e.length > 0) return e.join(", ");
      throw new Error(
        `Could not resolve value for theme function: \`theme(${n})\`. Consider checking if the variable name is correct or provide a fallback value to silence this error.`
      );
    }
    if (e.length === 0) return a;
    let l = e.join(", ");
    if (l === "initial") return a;
    if (a === "initial") return l;
    if (
      a.startsWith("var(") ||
      a.startsWith("theme(") ||
      a.startsWith("--theme(")
  ...
  function ii(t, r, n, ...e) {
    n = oi(n);
    let i = t.resolveThemeValue(n);
    if (!i && e.length > 0) return e.join(", ");
    if (!i)
      throw new Error(
        `Could not resolve value for theme function: \`theme(${n})\`. Consider checking if the path is correct or provide a fallback value to silence this error.`
      );
    return i;
  }
  var sr = new RegExp(
  ...
  function ur(t, r, n) {
    ...
    return (
      Q(e, (i, { replaceWith: a }) => {
        if (i.kind === "function" && i.value in bt) {
          let l = O(H(i.nodes).trim(), ",").map((f) => f.trim()),
            p = bt[i.value](n, r, ...l);
          return a(I(p));
        }
      }),
  ...
  function li(t, r) {
    Q(t, (n) => {
      if (
        n.kind === "function" &&
        !(n.value !== "var" && n.value !== "theme" && n.value !== "--theme")
      )
        if (n.nodes.length === 1)
          n.nodes.push({ kind: "word", value: `, ${r}` });
        else {
          let e = n.nodes[n.nodes.length - 1];
  ...
  function cr(t) {
    ...
    for (let e of t.utilities.keys("functional")) {
      ...
      for (let a of i)
        for (let l of a.values) {
          let p = l !== null && ai.test(l),
            f = l === null ? e : `${e}-${l}`;
          r.push({ name: f, utility: e, fraction: p, modifiers: a.modifiers }),
            a.supportsNegative &&
              r.push({
                name: `-${f}`,
                utility: `-${e}`,
    ...
    return r.length === 0 ? [] : (r.sort((e, i) => He(e.name, i.name)), si(r));
  }
  function si(t) {
    let r = [],
      n = null,
    ...
    for (let l of t) {
      ...
      n || ((n = { utility: p, items: [] }), e.set(p, n)),
        ...
        f ? i.get(p).push(l) : n.items.push(l);
    }
    ...
    let a = [];
    for (let l of r)
      for (let p of l.items) a.push([p.name, { modifiers: p.modifiers }]);
    return a;
  }
  function fr(t) {
    let r = [];
    for (let [e, i] of t.variants.entries()) {
      let p = function ({ value: f, modifier: d } = {}) {
        ...
        if (!m) return [];
        let g = D(".__placeholder__", []);
        if (ye(g, m, t.variants) === null) return [];
        let y = [];
        return (
          Ie(g.nodes, (b, { path: k }) => {
            if (
  ...
  var vt = class {
    ...
    compound(r, n, e, { compounds: i, order: a } = {}) {
      this.set(r, {
        kind: "compound",
        applyFn: e,
        compoundsWith: n,
    ...
    compare(r, n) {
      ...
      let e = this.variants.get(r.root).order,
        i = this.variants.get(n.root).order,
        a = e - i;
      if (a !== 0) return a;
    ...
    set(r, { kind: n, applyFn: e, compounds: i, compoundsWith: a, order: l }) {
      let p = this.variants.get(r);
      p
        ? Object.assign(p, { kind: n, applyFn: e, compounds: i })
        : (l === void 0 &&
  ...
  function mr(t) {
      ...
      if (
        (U([d], (g, { path: y }) => {
          ...
          let b = [],
            k = [];
          for (let x of y)
            x.kind === "at-rule" ? b.push(x) : x.kind === "rule" && k.push(x);
          ...
          return Object.assign(d, D("&", A)), (m = !0), 1;
        }),
        d.kind === "rule" &&
          d.selector === "&" &&
          d.nodes.length === 1 &&
    ...
    n("first", ["&:first-child"]),
      ...
      r.static("hover", (d) => {
        d.nodes = [D("&:hover", [P("@media", "(hover: hover)", d.nodes)])];
      }),
      n("focus", ["&:focus"]),
      ...
      r.functional("aria", (d, c) => {
        ...
        c.value.kind === "arbitrary"
          ? (d.nodes = [D(`&[aria-${pr(c.value.value)}]`, d.nodes)])
          : (d.nodes = [D(`&[aria-${c.value.value}="true"]`, d.nodes)]);
      }),
      r.suggest("aria", () => [
        "busy",
        "checked",
      ...
      r.functional("data", (d, c) => {
        if (!c.value || c.modifier) return null;
        d.nodes = [D(`&[data-${pr(c.value.value)}]`, d.nodes)];
      }),
      r.functional("nth", (d, c) => {
        if (
          !c.value ||
          c.modifier ||
          (c.value.kind === "named" && !T(c.value.value))
        )
          return null;
        d.nodes = [D(`&:nth-child(${c.value.value})`, d.nodes)];
      }),
      r.functional("nth-last", (d, c) => {
        if (
          ...
          return null;
        d.nodes = [D(`&:nth-last-child(${c.value.value})`, d.nodes)];
      }),
      r.functional("nth-of-type", (d, c) => {
        if (
          ...
          return null;
        d.nodes = [D(`&:nth-of-type(${c.value.value})`, d.nodes)];
      }),
      r.functional("nth-last-of-type", (d, c) => {
        if (
          ...
          return null;
        d.nodes = [D(`&:nth-last-of-type(${c.value.value})`, d.nodes)];
      }),
      r.functional(
        "supports",
        (d, c) => {
          ...
          if (/^[\w-]*\s*\(/.test(m)) {
            ...
            d.nodes = [P("@supports", g, d.nodes)];
            return;
          }
          m.includes(":") || (m = `${m}: var(--tw)`),
            (m[0] !== "(" || m[m.length - 1] !== ")") && (m = `(${m})`),
            (d.nodes = [P("@supports", m, d.nodes)]);
        },
        { compounds: 1 }
      ),
      ...
      n("contrast-less", ["@media (prefers-contrast: less)"]);
    {
      let d = function (c, m, g, y) {
        ...
        let k = y.get(m);
        return k === null ? (g === "asc" ? 1 : -1) : ce(b, k, g);
      };
      var f = d;
      {
          ...
          () => {
            r.functional(
              ...
              (g, y) => {
                ...
                g.nodes = [P("@media", `(width < ${b})`, g.nodes)];
              },
              { compounds: 1 }
            );
          },
              ...
              for (let [g, y] of t.namespace("--breakpoint"))
                g !== null &&
                  r.static(
                    g,
                    (b) => {
                      b.nodes = [P("@media", `(width >= ${y})`, b.nodes)];
                    },
                    { compounds: 1 }
                  );
              r.functional(
  ...
  function kt(t, r) {
    U(t, (n, { replaceWith: e }) => {
      if (n.kind === "at-rule" && n.name === "@slot") e(r);
        ...
        return Object.assign(n, K([P(n.name, n.params, n.nodes)])), 1;
    });
  }
  function gr(t) {
    let r = lr(t),
      ...
      l = new F((f) => {
        for (let d of Fe(f)) t.markUsedVariable(d);
      }),
      p = {
        theme: t,
        utilities: r,
        ...
        candidatesToCss(f) {
          ...
          for (let c of f) {
            ...
            (g = ue(g, p)), g.length === 0 || m ? d.push(null) : d.push(Y(g));
          }
          return d;
        },
        getClassOrder(f) {
        ...
        resolveThemeValue(f, d = !0) {
          let c = f.lastIndexOf("/"),
            m = null;
          c !== -1 && ((m = f.slice(c + 1).trim()), (f = f.slice(0, c).trim()));
          let g = t.resolve(null, [f], d ? 1 : 0) ?? void 0;
          return m && g ? J(g, m) : g;
        },
      ...
      for (let c of f) {
        ...
        if (m.length !== 0) {
          ...
          for (let { node: g, propertySort: y } of m) {
            ...
            e.set(g, { properties: y, variants: b, candidate: p }), i.push(g);
          }
        }
      }
      d || n?.(p);
  ...
  function hr(t, r) {
    ...
    for (let a of n) {
      let l = gi(a);
      (t.important || r.important) && yr(a);
      let p = { kind: "rule", selector: i, nodes: a };
      for (let f of t.variants) if (ye(p, f, r.variants) === null) return [];
      e.push({ node: p, propertySort: l });
    }
    return e;
  }
  function ye(t, r, n, e = 0) {
    if (r.kind === "arbitrary") {
    ...
    if (r.kind === "compound") {
      let l = P("@slot");
      if (
        ye(l, r.variant, n, e + 1) === null ||
        (r.root === "not" && l.nodes.length > 1)
      )
        return null;
      for (let f of l.nodes)
        if ((f.kind !== "rule" && f.kind !== "at-rule") || i(f, r) === null)
          return null;
      U(l.nodes, (f) => {
  ...
  function yr(t) {
    for (let r of t)
      r.kind !== "at-root" &&
        (r.kind === "declaration"
          ? (r.important = !0)
          : (r.kind === "rule" || r.kind === "at-rule") && yr(r.nodes));
  }
  function gi(t) {
    let r = new Set(),
      n = 0,
    ...
    for (; e.length > 0; ) {
      ...
      if (a.kind === "declaration") {
        if (a.value === void 0 || (n++, i)) continue;
        if (a.property === "--tw-sort") {
          let p = wt.indexOf(a.value ?? "");
          if (p !== -1) {
            r.add(p), (i = !0);
            continue;
          }
        }
        let l = wt.indexOf(a.property);
        l !== -1 && r.add(l);
      } else if (a.kind === "rule" || a.kind === "at-rule")
        for (let l of a.nodes) e.push(l);
    }
    return { order: Array.from(r).sort((a, l) => a - l), count: n };
  }
  function $e(t, r) {
    let n = 0,
      e = M("&", t),
    ...
    U([e], (m, { parent: g }) => {
      if (m.kind === "at-rule") {
          ...
          l.get(y).add(m),
            U(m.nodes, (b) => {
              if (!(b.kind !== "at-rule" || b.name !== "@apply")) {
                i.add(m);
                for (let k of vr(b, r)) a.get(m).add(k);
              }
            });
          return;
        }
        if (m.name === "@apply") {
          if (g === null) return;
          (n |= 1), i.add(g);
          for (let y of vr(m, r)) a.get(g).add(y);
        }
      }
    });
    let p = new Set(),
          ...
          throw (
            (m.kind === "at-rule" &&
              ...
              U(m.nodes, (b) => {
                ...
                for (let A of k)
                  for (let x of r.parseCandidate(A))
                    switch (x.kind) {
                      case "arbitrary":
                        break;
                      case "static":
                      case "functional":
                        if (y.params.replace(/-\*$/, "") === x.root)
                          throw new Error(
...
${Y([y])}`))
        ...
        for (let g = 0; g < m.nodes.length; g++) {
          ...
          let b = y.params.split(/\s+/g);
          {
            let k = oe(b, r, {
              ...
              A = [];
            for (let x of k)
              if (x.kind === "rule") for (let V of x.nodes) A.push(V);
              else A.push(x);
    ...
    return (
      U(t, (l, { replaceWith: p }) => {
        if (
          ...
          let f = hi(I(l.params));
          if (f === null) return;
          l.name === "@reference" && (f.media = "reference"), (i |= 2);
          ...
          return (
            a.push(
              (async () => {
                ...
                let b = await n(d, r),
                  k = me(b.content);
                await xt(k, b.base, n, e + 1),
                  (y.nodes = bi([X({ base: b.base }, k)], c, m, g));
              })()
            ),
            p(y),
            1
  ...
  function hi(t) {
    ...
    return r ? { uri: r, layer: n, media: e, supports: i } : null;
  }
  function bi(t, r, n, e) {
    let i = t;
    return (
      r !== null && (i = [P("@layer", r, i)]),
      n !== null && (i = [P("@media", n, i)]),
      e !== null && (i = [P("@supports", e[0] === "(" ? e : `(${e})`, i)]),
      i
    );
  }
  ...
  function kr(t, { theme: r }, n) {
    ...
    if (Object.hasOwn(r, "fontFamily")) {
      let e = 5;
      {
        let i = ve(r.fontFamily.sans);
        i &&
          t.theme.hasDefault("--font-sans") &&
          (t.theme.add("--default-font-family", i, e),
          t.theme.add(
            "--default-font-feature-settings",
            ve(r.fontFamily.sans, "fontFeatureSettings") ?? "normal",
            e
          ),
          t.theme.add(
            "--default-font-variation-settings",
            ve(r.fontFamily.sans, "fontVariationSettings") ?? "normal",
            e
          ));
      }
      {
        let i = ve(r.fontFamily.mono);
        i &&
          t.theme.hasDefault("--font-mono") &&
          (t.theme.add("--default-mono-font-family", i, e),
          t.theme.add(
            "--default-mono-font-feature-settings",
            ve(r.fontFamily.mono, "fontFeatureSettings") ?? "normal",
            e
          ),
          t.theme.add(
            "--default-mono-font-variation-settings",
            ve(r.fontFamily.mono, "fontVariationSettings") ?? "normal",
            e
          ));
      }
    }
  ...
  function yi(t) {
    ...
    return (
      wr(t, [], (n, e) => {
        if (ki(n)) return r.push([e, n]), 1;
        if (wi(n)) {
          r.push([e, n[0]]);
          for (let i of Reflect.ownKeys(n[1]))
            r.push([[...e, `-${i}`], n[1][i]]);
          return 1;
        }
        if (Array.isArray(n) && n.every((i) => typeof i == "string"))
  ...
  function Ye(t) {
    ...
    for (let r of t) if (!vi.test(r)) return null;
    return t
      .map((r, n, e) => (r === "1" && n !== e.length - 1 ? "" : r))
      .map((r) =>
        r
          .replaceAll(".", "_")
          .replace(/([a-z])([A-Z])/g, (n, e, i) => `${e}-${i.toLowerCase()}`)
      )
  ...
  function wr(t, r = [], n) {
    for (let e of Reflect.ownKeys(t)) {
      ...
      if (l !== 1) {
        if (l === 2) return 2;
        if (!(!Array.isArray(i) && typeof i != "object") && wr(i, a, n) === 2)
          return 2;
      }
    }
  }
    ...
    for (let n of O(t, ".")) {
      ...
      for (;;) {
        let i = n.indexOf("[", e),
          a = n.indexOf("]", i);
        if (i === -1 || a === -1) break;
        i > e && r.push(n.slice(e, i)), r.push(n.slice(i + 1, a)), (e = a + 1);
      }
  ...
  function Ze(t, r, n) {
    return function (i, a) {
      let l = i.lastIndexOf("/"),
        p = null;
      l !== -1 && ((p = i.slice(l + 1).trim()), (i = i.slice(0, l).trim()));
      let f = (() => {
        let d = Je(i),
          [c, m] = xi(t.theme, d),
          g = n(xr(r() ?? {}, d) ?? null);
        ...
        if (g !== null && typeof g == "object" && !Array.isArray(g)) {
          ...
          for (let b in c)
            b !== "__CSS_VALUES__" &&
              ((g?.__CSS_VALUES__?.[b] & 4 && xr(y, b.split("-")) !== void 0) ||
                (y[se(b)] = c[b]));
          return y;
        }
      ...
      return p && typeof f == "string" && (f = J(f, p)), f ?? a;
    };
  }
  function xi(t, r) {
    ...
    for (let [c, m] of a) {
      ...
      (b = b.replace(/-([a-z])/g, (k, A) => A.toUpperCase())),
        i.get(y === "" ? null : y).set(b, [m, t.getOptions(`--${n}${c}`)]);
    }
    ...
    for (let [c, m] of i) {
      ...
      let y = {},
        b = {};
      for (let [k, [A, x]] of m) (y[k] = A), (b[k] = x);
      e.set(c, [g, y]), l.set(c, [p, b]);
    }
    let f = {},
      d = {};
    for (let [c, m] of e) Ar(f, [c ?? "DEFAULT"], m);
    for (let [c, m] of l) Ar(d, [c ?? "DEFAULT"], m);
  ...
  function Ee(t, r, n = null) {
    for (let e = 0; e < t.length; e++) {
      ...
      if (p === 2) return 2;
      if (p !== 1 && i.kind === "function" && Ee(i.nodes, r, i) === 2) return 2;
    }
  }
  function Re(t) {
    let r = "";
...
`
    ...
    for (let l = 0; l < t.length; l++) {
      ...
      switch (p) {
        ...
        case Cr: {
          ...
          (i += String.fromCharCode(p) + String.fromCharCode(f)), (l += 1);
          break;
        }
        default:
          i += String.fromCharCode(p);
    ...
    return i.length > 0 && r.push(Ve(i)), r;
  }
  ...
  function At({
    ...
    let a = {
      addBase(l) {
        if (i) return;
        let p = ee(l);
        (e.current |= be(p, t)), r.push(P("@layer", "base", p));
      },
      addVariant(l, p) {
        if (!Ge.test(l))
          throw new Error(
        ...
        typeof p == "string" || Array.isArray(p)
          ? t.variants.static(
              l,
              (f) => {
                f.nodes = Kr(p, f.nodes);
              },
              { compounds: de(typeof p == "string" ? [p] : p) }
            )
          : typeof p == "object" && t.variants.fromAst(l, ee(p));
      },
      matchVariant(l, p, f) {
        function d(m, g, y) {
        ...
        for (let [d, c] of f)
          t.theme.prefix &&
            ...
            t.utilities.static(d, (m) => {
              ...
              return Dr(g, d, m.raw), (e.current |= $e(g, t)), g;
            });
      },
      matchUtilities(l, p) {
        let f = p?.type
            ...
            return (b) => {
              if (
                ...
                ((b.value.dataType && !f.includes(b.value.dataType)) ||
                  (!b.value.dataType && !L(b.value.value, f)))
              )
                return;
              ...
              let V;
              {
                ...
                b.modifier
                  ? R === "any" || b.modifier.kind === "arbitrary"
                    ? (V = b.modifier.value)
                    : R?.[b.modifier.value]
                    ? (V = R[b.modifier.value])
                    : k && !Number.isNaN(Number(b.modifier.value))
                    ? (V = `${b.modifier.value}%`)
                    : (V = null)
                  : (V = null);
              }
              if (b.modifier && V === null && !x)
                return b.value?.kind === "arbitrary" ? null : void 0;
              k && V !== null && (A = J(A, V)), y && (A = `calc(${A} * -1)`);
              let _ = ee(m(A, { modifier: V }));
              return Dr(_, c, b.raw), (e.current |= $e(_, t)), _;
            };
          };
          var d = g;
          if (!_r.test(c))
  ...
  function ee(t) {
    ...
    for (let [e, i] of n)
      if (typeof i != "object") {
        ...
        for (let a of i)
          typeof a == "string" ? r.push(s(e, a)) : r.push(M(e, ee(a)));
      else i !== null && r.push(M(e, ee(i)));
    return r;
  }
  function Kr(t, r) {
  ...
  var Z = pe((t) => {
    ...
    Ir = {
      ...
      aspectRatio: { auto: "auto", square: "1 / 1", video: "16 / 9", ..._i },
      ...
      backdropHueRotate: ({ theme: t }) => ({ ...t("hueRotate"), ...et }),
      ...
      divideWidth: ({ theme: t }) => ({ ...t("borderWidth"), ...le }),
      dropShadow: {
      ...
      outlineWidth: { 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...le },
  ...
  function St(t, r) {
    let n = {
      ...
      theme: {},
      extend: {},
      result: structuredClone(Ki),
    };
    for (let i of r) Ct(n, i);
    for (let i of n.configs)
      "darkMode" in i &&
        i.darkMode !== void 0 &&
        (n.result.darkMode = i.darkMode ?? null),
        "prefix" in i &&
          i.prefix !== void 0 &&
          (n.result.prefix = i.prefix ?? ""),
        "blocklist" in i &&
          i.blocklist !== void 0 &&
          (n.result.blocklist = i.blocklist ?? []),
        "important" in i &&
          i.important !== void 0 &&
          (n.result.important = i.important ?? !1);
    let e = ji(n);
    return {
      resolvedConfig: {
        ...n.result,
  ...
  function Di(t, r) {
    if (Array.isArray(t) && ke(t[0])) return t.concat(r);
    if (Array.isArray(r) && ke(r[0]) && ke(t)) return [t, ...r];
    if (Array.isArray(r)) return r;
  }
  function Ct(t, { config: r, base: n, path: e, reference: i }) {
    let a = [];
    for (let f of r.plugins ?? [])
      "__isOptionsFunction" in f
        ? a.push({ ...f(), reference: i })
        : "handler" in f
        ? a.push({ ...f, reference: i })
        : a.push({ handler: f, reference: i });
    ...
    for (let f of r.presets ?? [])
      Ct(t, { path: e, base: n, config: f, reference: i });
    for (let f of a)
      t.plugins.push(f),
        f.config &&
          Ct(t, {
  ...
  function ji(t) {
    let r = new Set(),
      n = Ze(t.design, () => t.theme, i),
      e = Object.assign(n, { theme: n, colors: Xe });
    function i(a) {
      return typeof a == "function" ? a(e) ?? null : a ?? null;
    }
    for (let a of t.configs) {
      let l = a.theme ?? {},
        p = l.extend ?? {};
    ...
    for (let a in t.extend) {
      let l = [t.theme[a], ...t.extend[a]];
      t.theme[a] = () => {
        let p = l.map(i);
        return Te({}, p, Di);
      };
    }
    for (let a in t.theme) t.theme[a] = i(t.theme[a]);
    if (t.theme.screens && typeof t.theme.screens == "object")
      for (let a of Object.keys(t.theme.screens)) {
        let l = t.theme.screens[a];
        l &&
          typeof l == "object" &&
          ("raw" in l ||
            "max" in l ||
            ("min" in l && (t.theme.screens[a] = l.min)));
      }
    return r;
  }
  function Mr(t, r) {
  ...
  function zi({ center: t, padding: r, screens: n }, e) {
    let i = [],
      a = null;
    if (
      (t && i.push(s("margin-inline", "auto")),
      (typeof r == "string" ||
        (typeof r == "object" && r !== null && "DEFAULT" in r)) &&
        i.push(s("padding-inline", typeof r == "string" ? r : r.DEFAULT)),
      typeof n == "object" && n !== null)
    ) {
      a = new Map();
      let l = Array.from(e.theme.namespace("--breakpoint").entries());
      if ((l.sort((p, f) => ce(p[1], f[1], "asc")), l.length > 0)) {
        let [p] = l[0];
        i.push(
          P("@media", `(width >= --theme(--breakpoint-${p}))`, [
            s("max-width", "none"),
          ])
        );
      }
      for (let [p, f] of Object.entries(n)) {
        ...
        a.set(p, P("@media", `(width >= ${f})`, [s("max-width", f)]));
      }
    }
    if (typeof r == "object" && r !== null) {
      let l = Object.entries(r)
        ...
        .filter(Boolean);
      l.sort((p, f) => ce(p[1], f[1], "asc"));
      for (let [p, , f] of l)
        if (a && a.has(p)) a.get(p).nodes.push(s("padding-inline", f));
        else {
          if (a) continue;
          i.push(
            P("@media", `(width >= theme(--breakpoint-${p}))`, [
    ...
    if (a) for (let [, l] of a) i.push(l);
    return i;
  }
  function Wr({ addVariant: t, config: r }) {
    let n = r("darkMode", null),
      [e, i = ".dark"] = Array.isArray(n) ? n : [n];
    if (e === "variant") {
      let a;
      if (
  ...
  function Br(t) {
    for (let [r, n] of [
      ...
      t.utilities.static(`bg-gradient-to-${r}`, () => [
        s("--tw-gradient-position", `to ${n} in oklab`),
    ...
    t.utilities.functional("max-w-screen", (r) => {
      ...
      t.utilities.functional("flex-shrink", (r) => {
        if (!r.modifier) {
          if (!r.value) return [s("flex-shrink", "1")];
          if (r.value.kind === "arbitrary")
            return [s("flex-shrink", r.value.value)];
          if (T(r.value.value)) return [s("flex-shrink", r.value.value)];
        }
      }),
      t.utilities.functional("flex-grow", (r) => {
        if (!r.modifier) {
          if (!r.value) return [s("flex-grow", "1")];
          if (r.value.kind === "arbitrary")
            return [s("flex-grow", r.value.value)];
          if (T(r.value.value)) return [s("flex-grow", r.value.value)];
        }
      });
  }
  function qr(t, r) {
    ...
    if (i.length !== 0) {
      for (let [, l] of r.variants.variants)
        l.order > e && (l.order += i.length);
      r.variants.compareFns = new Map(
        Array.from(r.variants.compareFns).map(
          ([l, p]) => (l > e && (l += i.length), [l, p])
        )
      );
      for (let [l, p] of i.entries()) p(e + l + 1);
    }
  }
  function Fi(t) {
  ...
  function Hr(t, r) {
    ...
    if (Object.keys(i).length > 0) {
      ...
      r.variants.functional(
        ...
        (f, d) => {
          let c = d.value;
          return c && c.kind === "named" && c.value in i
            ? l?.(f, { ...d, value: { kind: "arbitrary", value: i[c.value] } })
            : l?.(f, d);
        },
        { compounds: p }
      );
  ...
  async function Yr({
    ...
    let a = 0,
      l = [],
      p = [];
    U(n, (m, { parent: g, replaceWith: y, context: b }) => {
      if (m.kind === "at-rule") {
        if (m.name === "@plugin") {
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
    ...
    if (
      ((t.resolveThemeValue = function (g, y) {
        return g.startsWith("--")
          ? f(g, y)
          : ((a |= Gr({
              designSystem: t,
  ...
  function Gr({
    ...
    let l = 0,
      ...
      { resolvedConfig: d } = St(t, [
        { config: Lr(t.theme), base: r, reference: !0 },
        ...f,
        { config: { plugins: [Wr] }, base: r, reference: !0 },
      ]),
      { resolvedConfig: c, replacedThemeKeys: m } = St(t, f);
    t.resolveThemeValue = function (A, x) {
      let V = y.theme(A, x);
    ...
    let g = {
      ...
      y = At({ ...g, referenceMode: !1 }),
      b;
    for (let { handler: k, reference: A } of d.plugins)
      A ? ((b ||= At({ ...g, referenceMode: !0 })), k(b)) : k(y);
    if (
      (kr(t, c, m),
      jr(t, c, m),
      Hr(c, t),
    ...
    if (
      ...
      let k = d.important;
      U(n, (A, { replaceWith: x, parent: V }) => {
        if (
          A.kind === "at-rule" &&
          !(A.name !== "@tailwind" || A.params !== "utilities")
        )
          return V?.kind === "rule" && V.selector === k ? 2 : (x(D(k, [A])), 2);
      });
    }
...
This feature is not currently supported.`);
  ...
  function tt(t) {
    ...
    let p = i.slice(1, l),
      f = i.slice(l + 1),
      d;
    Li(p) ? (d = Mi(p)) : (d = O(p, ",")), (d = d.flatMap((m) => tt(m)));
    let c = tt(f);
  ...
  async function Gi(
    t,
    { base: r = "", loadModule: n = Bi, loadStylesheet: e = qi } = {}
  ) {
    let i = 0;
    (t = [X({ base: r }, t)]), (i |= await xt(t, r, e));
    let a = null,
      l = new ze(),
      p = [],
      f = [],
      ...
      b = [],
      k = null;
    U(t, (x, { parent: V, replaceWith: _, context: R }) => {
      if (x.kind === "at-rule") {
        if (
          x.name === "@tailwind" &&
          (x.params === "utilities" || x.params.startsWith("utilities"))
        ) {
          if (c !== null) {
            _([]);
            return;
        ...
        if (x.name === "@utility") {
          ...
          if (x.nodes.length === 0)
            throw new Error(
              `\`@utility ${x.params}\` is empty. Utilities should include at least one property.`
            );
          let j = ar(x);
          if (j === null)
            throw new Error(
              `\`@utility ${x.params}\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter.`
            );
          f.push(j);
        }
        if (x.name === "@source") {
          ...
          if (!1) {
            let w = j ? b : y,
              v = O(h, " ");
            for (let N of v) for (let E of tt(N)) w.push(E);
        ...
        if (
          (x.name === "@variant" &&
            (V === null
              ? x.nodes.length === 0
                ? (x.name = "@custom-variant")
                : (U(x.nodes, (j) => {
                    if (j.kind === "at-rule" && j.name === "@slot")
                      return (x.name = "@custom-variant"), 2;
                  }),
                  x.name === "@variant" && m.push(x))
              : m.push(x)),
          x.name === "@custom-variant")
        ) {
          if (V !== null)
          ...
          if (!Ge.test(j))
            throw new Error(
              `\`@custom-variant ${j}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`
            );
          if (x.nodes.length > 0 && o)
            throw new Error(
              `\`@custom-variant ${j}\` cannot have both a selector and a body.`
            );
          if (x.nodes.length === 0) {
            if (!o)
              throw new Error(
                `\`@custom-variant ${j}\` has no selector or body.`
              );
            let u = O(o.slice(1, -1), ",");
            if (u.length === 0 || u.some((v) => v.trim() === ""))
              throw new Error(
                `\`@custom-variant ${j} (${u.join(",")})\` selector is invalid.`
              );
            let h = [],
              w = [];
            for (let v of u)
              (v = v.trim()), v[0] === "@" ? h.push(v) : w.push(v);
            p.push((v) => {
              v.variants.static(
                j,
                (N) => {
                  let E = [];
                  w.length > 0 && E.push(D(w.join(", "), N.nodes));
            ...
            if (u.startsWith("source(")) {
              ...
              U(x.nodes, (w, { replaceWith: v }) => {
                if (
                  ...
                  return (
                    (w.params += ` source(${h})`),
                    v([X({ sourceBase: R.base }, [w])]),
                    2
                  );
              });
            } else if (u.startsWith("theme(")) {
              let h = u.slice(6, -1),
                w = h.includes("reference");
              U(x.nodes, (v) => {
                if (v.kind !== "at-rule") {
                  if (w)
                    throw new Error(
              ...
              U(x.nodes, (w) => {
                if (w.kind === "at-rule" && w.name === "@theme")
                  return (w.params += ` prefix(${h})`), 1;
              });
            } else
              u === "important"
                ? (a = !0)
                : u === "reference"
                ? (x.nodes = [X({ reference: !0 }, x.nodes)])
                : o.push(u);
          o.length > 0 ? (x.params = o.join(" ")) : j.length > 0 && _(x.nodes);
        }
        if (x.name === "@theme") {
          let [j, o] = Hi(x.params);
          if ((R.reference && (j |= 2), o)) {
            if (!Wi.test(o))
              throw new Error(
          ...
          return (
            U(x.nodes, (u) => {
              ...
              if (u.kind === "declaration" && u.property.startsWith("--")) {
                l.add(se(u.property), u.value ?? "", j);
                return;
              }
              let h = Y([P(x.name, x.params, [u])])
                .split(
                  `
`
                )
...
${h}`);
    ...
    let A = gr(l);
    if ((a && (A.important = a), b.length > 0))
      for (let x of b) A.invalidCandidates.add(x);
    i |= await Yr({
      designSystem: A,
      base: r,
      ast: t,
    ...
    if (d) {
      let x = [];
      for (let [_, R] of A.theme.entries())
        R.options & 2 || x.push(s(ne(_), R.value));
      let V = A.theme.getKeyframes();
      for (let _ of V) t.push(X({ theme: !0 }, [K([_])]));
      d.nodes = [X({ theme: !0 }, x)];
    }
    if (c) {
      let x = c;
    ...
    if (m.length > 0) {
      for (let x of m) {
        let V = D("&", x.nodes),
          ...
          R = A.parseVariant(_);
        if (R === null)
          throw new Error(`Cannot use \`@variant\` with unknown variant: ${_}`);
        if (ye(V, R, A.variants) === null)
          throw new Error(`Cannot use \`@variant\` with variant: ${_}`);
        Object.assign(x, V);
      }
      i |= 32;
    }
    return (
      ...
      (i |= $e(t, A)),
      U(t, (x, { replaceWith: V }) => {
        if (x.kind === "at-rule") return x.name === "@utility" && V([]), 1;
      }),
      {
        designSystem: A,
        ast: t,
  ...
  async function Yi(t, r = {}) {
    ...
    e.unshift(
      je(`! tailwindcss v${Vt} | MIT License | https://tailwindcss.com `)
    );
    function d(b) {
    ...
    return {
      ...
      build(b) {
        if (p === 0) return t;
        if (!l) return (m ??= ue(e, n)), m;
        let k = y,
          A = !1;
        y = !1;
        let x = c.size;
        for (let _ of b)
          if (!n.invalidCandidates.has(_))
            if (_[0] === "-" && _[1] === "-") {
              let R = n.theme.markUsedVariable(_);
              (k ||= R), (A ||= R);
            } else c.add(_), (k ||= c.size !== x);
        if (!k) return (m ??= ue(e, n)), m;
        let V = oe(c, n, { onInvalidCandidate: d }).astNodes;
        return !A && g === V.length
          ? ((m ??= ue(e, n)), m)
          : ((g = V.length), (l.nodes = V), (m = ue(e, n)), m);
      },
    };
  }
  async function Qr(t, r = {}) {
    ...
    return {
      ...
      build(l) {
        let p = e.build(l);
        return p === i || ((a = Y(p)), (i = p)), a;
      },
    };
  }
  var Xr = `@layer theme, base, components, utilities;
...
`;
  var rn = `@tailwind utilities;
`;
  var Oe = { index: Xr, preflight: en, theme: tn, utilities: rn };
  var rt = class {
    start(r) {
  ...
  async function no() {
    ...
    let t = document.querySelectorAll(`style[type="${on}"]`),
      r = "";
    for (let n of t)
      ln(n),
        (r +=
...
`);
    if (
      ...
      B.end("Reading Stylesheets", { size: r.length, changed: Nt !== r }),
      Nt !== r)
    ) {
      (Nt = r), B.start("Compile CSS");
      try {
        nt = await Qr(r, { base: "/", loadStylesheet: io, loadModule: oo });
      } finally {
  ...
  async function io(t, r) {
    function n() {
      if (t === "tailwindcss") return { base: r, content: Oe.index };
      if (
        t === "tailwindcss/preflight" ||
        t === "tailwindcss/preflight.css" ||
        t === "./preflight.css"
      )
        return { base: r, content: Oe.preflight };
      if (
        t === "tailwindcss/theme" ||
        t === "tailwindcss/theme.css" ||
        t === "./theme.css"
      )
        return { base: r, content: Oe.theme };
      if (
        t === "tailwindcss/utilities" ||
        t === "tailwindcss/utilities.css" ||
        t === "./utilities.css"
      )
        return { base: r, content: Oe.utilities };
  ...
  async function lo(t) {
    ...
    for (let n of document.querySelectorAll("[class]"))
      for (let e of n.classList) $t.has(e) || ($t.add(e), r.add(e));
    B.end("Collect classes", { count: r.size }),
      !(r.size === 0 && t === "incremental") &&
        (B.start("Build utilities"),
        (Tt.textContent = nt.build(Array.from(r))),
  ...
  function it(t) {
    ...
    nn = nn.then(r).catch((n) => B.error(n));
  }
  var ao = new MutationObserver(() => it("full"));
  function ln(t) {
    ao.observe(t, {
      attributes: !0,
    ...
    for (let e of t) {
      for (let i of e.addedNodes)
        i.nodeType === Node.ELEMENT_NODE &&
          i.tagName === "STYLE" &&
          i.getAttribute("type") === on &&
          (ln(i), r++);
      for (let i of e.addedNodes) i.nodeType === 1 && i !== Tt && n++;
      e.type === "attributes" && n++;
    }
    if (r > 0) return it("full");
    if (n > 0) return it("incremental");
