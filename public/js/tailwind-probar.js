//
// ESTO CREO Q ES UNA VERSION MAS ACTUAL DE TAILWIND(POSIBLE V4) - PERO HASTA EL DIA NO PUEDO CONFIGURARLO
//                                                                                              XD
"use strict";
(() => {
    var e = 10;
    ...
    function T(e, t, r = 3) {
        ...
        function v(e, c, p = {}, h = 0) {
            if ("declaration" === e.kind) {
                ...
                if ("animation" === e.property)
                    for (let t of E(e.value)) s.add(t);
                2 & r && e.value.includes("color-mix(") && i.get(c).add(e),
                    c.push(e);
            } else if ("rule" === e.kind)
                if ("&" === e.selector)
                        ...
                        "declaration" === t.kind &&
                            ("initial-value" === t.property
                                ...
                                : "inherits" === t.property &&
                                  (n = "true" === t.value));
                    n
                        ? u.push(y(t, r ?? "initial"))
                        : d.push(y(t, r ?? "initial"));
                }
                o.add(e.params);
                let t = { ...e, nodes: [] };
                for (let r of e.nodes) v(r, t.nodes, p, h + 1);
        ...
        if (1 & r) {
            ...
            if (
                ...
                d.length > 0 &&
                    e.push(b("*, ::before, ::after, ::backdrop", d)),
                e.length > 0)
            ) {
                let t = w.findIndex(
                    (e) =>
    ...
    var Y = {
        color: function (e) {
            return (
                35 === e.charCodeAt(0) || Z.test(e) || H.has(e.toLowerCase())
            );
        },
        length: se,
        percentage: ae,
    ...
    var Ce = /(\d+)_(\d+)/g;
    var Se = ["number", "integer", "ratio", "percentage"];
    function Ke(e, t, r) {
        for (let n of t.nodes) {
            ...
            if (
                ...
                if ("named" === e.kind && "word" === n.kind) {
                    if (!Se.includes(n.value)) continue;
                    let t =
    ...
    function Fe(e, t) {
        ...
        return (
            A(e, (e) => {
                if ("declaration" === e.kind && e.value && Oe.test(e.value))
                    return (r |= 8), void (e.value = We(e.value, e, t));
                "at-rule" === e.kind &&
                    ("@media" === e.name ||
                        "@custom-media" === e.name ||
                        "@container" === e.name ||
    ...
    function We(e, t, r) {
        ...
        return (
            p(n, (e, { replaceWith: n }) => {
                if ("function" === e.kind && e.value in Ne) {
                    let o = R(h(e.nodes).trim(), ",").map((e) => e.trim());
                    return n(m(Ne[e.value](r, t, ...o)));
                }
            }),
            h(n)
        );
              ...
              (function (e) {
                  ...
                  for (let e of t)
                      for (let t of e.items)
                          a.push([t.name, { modifiers: t.modifiers }]);
                  return a;
              })(t));
    }
    var _e = /^@?[a-zA-Z0-9_-]*$/,
    ...
    function qe(e) {
        let t = (function (e) {
                ...
                function d({ negative: t }) {
                    return (r) => {
                        ...
                        if ("arbitrary" === r.value.kind) {
                            n = r.value.value;
                            let e =
                                r.value.dataType ?? G(n, ["angle", "vector"]);
                            if ("vector" === e)
                ...
                let p = () =>
                    z([$e("--tw-scroll-snap-strictness", "proximity", "*")]);
            ...
            r = (function (e) {
                ...
                r("first", ["&:first-child"]),
                    ...
                    t.functional("aria", (e, t) => {
                        ...
                        "arbitrary" === t.value.kind
                            ? (e.nodes = [
                                  w(`&[aria-${Re(t.value.value)}]`, e.nodes),
                              ])
                            : (e.nodes = [
                                  w(`&[aria-${t.value.value}="true"]`, e.nodes),
                              ]);
                    }),
                    t.suggest("aria", () => [
                        "busy",
                    ...
                    t.functional("data", (e, t) => {
                        if (!t.value || t.modifier) return null;
                        e.nodes = [w(`&[data-${Re(t.value.value)}]`, e.nodes)];
                    }),
                    ...
                    t.functional("nth-last", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            w(`&:nth-last-child(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional("nth-of-type", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            w(`&:nth-of-type(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional("nth-last-of-type", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            w(`&:nth-last-of-type(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional(
                        "supports",
            ...
            n = new c((e) =>
                (function (e, t) {
                    if ("[" === e[0] && "]" === e[e.length - 1]) {
                        ...
                        let t = W(e.slice(1, -1));
                        if (!L(t) || 0 === t.length || 0 === t.trim().length)
                            return null;
                        let r = ">" === t[0] || "+" === t[0] || "~" === t[0];
                        return (
                            !r &&
            ...
            i = new c((e) => {
                let t = (function (e, t) {
                    ...
                    for (let o of r) {
                        let r = Je(o);
                        (e.important || t.important) && Ge(o);
                        let i = { kind: "rule", selector: a, nodes: o };
                        for (let r of e.variants)
                            if (null === Ze(i, r, t.variants)) return [];
            ...
            s = {
                ...
                candidatesToCss(e) {
                    ...
                    for (let r of e) {
                        let e = !1,
                            { astNodes: n } = He([r], this, {
                                onInvalidCandidate() {
                                    e = !0;
                                },
                            });
                        (n = T(n, s, 0)),
                            0 === n.length || e ? t.push(null) : t.push(C(n));
                    }
                    return t;
                },
                getClassOrder(e) {
                    return (function (e, t) {
                        let { astNodes: r, nodeSorting: n } = He(
                                Array.from(t),
                                e
                            ),
                    ...
                    return (function (e) {
                        ...
                        for (let [r, n] of e.variants.entries()) {
                            let o = function ({ value: t, modifier: n } = {}) {
                                ...
                                if (null === Ze(l, i, e.variants)) return [];
                                let s = [];
                                return (
                                    j(l.nodes, (e, { path: t }) => {
                                        if (
    ...
    function He(e, t, { onInvalidCandidate: r } = {}) {
        let n = new Map(),
            o = [],
            a = new Map();
        for (let n of e) {
            ...
            for (let r of l) {
                ...
                if (0 !== l.length) {
                    ...
                    for (let { node: t, propertySort: a } of l) {
                        ...
                        n.set(t, { properties: a, variants: l, candidate: e }),
                            o.push(t);
                    }
                }
            }
            ...
            o.sort((e, t) => {
                ...
                return (
                    (r.properties.order[a] ?? 1 / 0) -
                        (o.properties.order[a] ?? 1 / 0) ||
                    o.properties.count - r.properties.count ||
                    Ue(r.candidate, o.candidate)
                );
            }),
        ...
        for (; n.length > 0; ) {
            ...
            if ("declaration" === e.kind) {
                ...
                if ("--tw-sort" === e.property) {
                    let r = Pe.indexOf(e.value ?? "");
                    if (-1 !== r) {
                        t.add(r), (o = !0);
                        continue;
                    }
                }
                let n = Pe.indexOf(e.property);
                -1 !== n && t.add(n);
        ...
        A([n], (e, { parent: n }) => {
            if ("at-rule" === e.kind) {
                    ...
                    return (
                        ...
                        void A(e.nodes, (r) => {
                            if ("at-rule" === r.kind && "@apply" === r.name) {
                                o.add(e);
                                for (let n of Qe(r, t)) a.get(e).add(n);
                            }
                        })
                    );
                }
                if ("@apply" === e.name) {
                    if (null === n) return;
                    (r |= 1), o.add(n);
                    for (let r of Qe(e, t)) a.get(n).add(r);
                }
            }
        });
        let l = new Set(),
    ...
    function rt(e, { theme: t }, r) {
        ...
        if (Object.hasOwn(t, "fontFamily")) {
            let r = 5;
            {
                let n = tt(t.fontFamily.sans);
                n &&
                    e.theme.hasDefault("--font-sans") &&
                    (e.theme.add("--default-font-family", n, r),
                    e.theme.add(
                        "--default-font-feature-settings",
                        tt(t.fontFamily.sans, "fontFeatureSettings") ??
                            "normal",
                        r
                    ),
                    e.theme.add(
                        "--default-font-variation-settings",
                        tt(t.fontFamily.sans, "fontVariationSettings") ??
                            "normal",
                        r
                    ));
            }
            {
                ...
                n &&
                    ...
                    e.theme.add(
                        ...
                        tt(t.fontFamily.mono, "fontFeatureSettings") ??
                            "normal",
                        r
                    ),
                    e.theme.add(
                        "--default-mono-font-variation-settings",
                        tt(t.fontFamily.mono, "fontVariationSettings") ??
                            "normal",
                        r
                    ));
            }
    ...
    function ot(e) {
        ...
        for (let t of e) if (!nt.test(t)) return null;
        return e
    ...
    function ct(e, t, r) {
        return function (n, o) {
            let i = n.lastIndexOf("/"),
                l = null;
            -1 !== i &&
                ((l = n.slice(i + 1).trim()), (n = n.slice(0, i).trim()));
            let s = (() => {
                let o = it(n),
                    [i, l] = (function (e, t) {
                        ...
                        let s = {},
                            u = {};
                        for (let [e, t] of n) dt(s, [e ?? "DEFAULT"], t);
                        for (let [e, t] of i) dt(u, [e ?? "DEFAULT"], t);
    ...
    function vt(e, t, r = null) {
        for (let n = 0; n < e.length; n++) {
            ...
            if (a) 0 === l ? n-- : (n += i - 1);
                ...
                if (2 === l) return 2;
                if (1 !== l && "function" === o.kind && 2 === vt(o.nodes, t, o))
                    return 2;
            }
        }
    }
    ...
    function kt(e) {
        ...
        for (let i = 0; i < e.length; i++) {
            ...
            switch (l) {
                ...
                case 92: {
                    ...
                    (a += String.fromCharCode(l) + String.fromCharCode(t)),
                        (i += 1);
                    break;
                }
                default:
        ...
        return a.length > 0 && r.push(ht(a)), r;
    }
    ...
    function yt({
        ...
        let a = {
            addBase(r) {
                if (o) return;
                let a = xt(r);
                (n.current |= Fe(a, e)), t.push(k("@layer", "base", a));
            },
            addVariant(t, r) {
                if (!_e.test(t))
                    throw new Error(
            ...
            matchVariant(t, r, n) {
                function o(e, t, n) {
                    return $t(r(e, { modifier: t?.value ?? null }), n);
                }
                ...
                for (let [t, r] of i)
                    e.theme.prefix &&
                        ...
                        e.utilities.static(t, (o) => {
                            ...
                            return zt(a, t, o.raw), (n.current |= Xe(a, e)), a;
                        });
            },
            matchUtilities(t, r) {
                let o = r?.type
                ...
                for (let [a, i] of Object.entries(t)) {
                    let t = function ({ negative: t }) {
                        return (l) => {
                            ...
                            c && null !== s && (u = ze(u, s)),
                                t && (u = `calc(${u} * -1)`);
                            let f = xt(i(u, { modifier: s }));
                            return zt(f, a, l.raw), (n.current |= Xe(f, e)), f;
                        };
                    };
                    if (!bt.test(a))
                        throw new Error(
    ...
    var Ct = Tt((e) => {
        ...
        Ft = {
            ...
            backdropContrast: ({ theme: e }) => ({ ...e("contrast"), ...St }),
            backdropGrayscale: ({ theme: e }) => ({ ...e("grayscale"), ...St }),
            backdropHueRotate: ({ theme: e }) => ({ ...e("hueRotate"), ...Vt }),
            backdropInvert: ({ theme: e }) => ({ ...e("invert"), ...St }),
            backdropOpacity: ({ theme: e }) => ({ ...e("opacity"), ...St }),
            backdropSaturate: ({ theme: e }) => ({ ...e("saturate"), ...St }),
            backdropSepia: ({ theme: e }) => ({ ...e("sepia"), ...St }),
            ...
            divideWidth: ({ theme: e }) => ({ ...e("borderWidth"), ...Kt }),
            dropShadow: {
            ...
            flexGrow: { 0: "0", DEFAULT: "1", ...Ct },
            flexShrink: { 0: "0", DEFAULT: "1", ...Ct },
            fontFamily: {
                sans: [
                    "ui-sans-serif",
                    "system-ui",
    ...
    function Dt(e, t) {
        let r = {
            ...
            theme: {},
            extend: {},
            result: structuredClone(Ut),
        };
        for (let e of t) _t(r, e);
    ...
    function Bt(e, t) {
        return Array.isArray(e) && lt(e[0])
            ? e.concat(t)
            : Array.isArray(t) && lt(t[0]) && lt(e)
            ? [e, ...t]
            : Array.isArray(t)
            ? t
            : void 0;
    }
    function _t(e, { config: t, base: r, path: n, reference: o }) {
        let a = [];
        ...
        for (let a of t.presets ?? [])
            _t(e, { path: n, base: r, config: a, reference: o });
        for (let t of a)
            e.plugins.push(t),
                t.config &&
                    _t(e, {
    ...
    function Lt(e, t) {
        ...
        let n = (function ({ center: e, padding: t, screens: r }, n) {
            ...
            if ("object" == typeof t && null !== t) {
                ...
                for (let [t, , r] of e)
                    if (a && a.has(t))
                        a.get(t).nodes.push(y("padding-inline", r));
                    else {
                        if (a) continue;
                        o.push(
                            k("@media", `(width >= theme(--breakpoint-${t}))`, [
        ...
        0 !== n.length &&
            t.utilities.static("container", () => structuredClone(n));
    }
    function Mt({ addVariant: e, config: t }) {
    ...
    function Pt({
        ...
        let i = 0,
            ...
            { resolvedConfig: s } = Dt(e, [
                { config: Wt(e.theme), base: t, reference: !0 },
                ...l,
                { config: { plugins: [Mt] }, base: t, reference: !0 },
            ]),
    ...
    async function Xt(
        e,
        { base: t = "", loadModule: r = Gt, loadStylesheet: n = Jt } = {}
    ) {
        let i = 0;
        (e = [$({ base: t }, e)]), (i |= await et(e, t, n));
        let l = null,
            c = new s(),
            u = [],
            d = [],
            ...
            if ("at-rule" === e.kind) {
                ...
                if ("@utility" === e.name) {
                    ...
                    let r = (function (e) {
                        ...
                        return be.test(t)
                                                  ...
                                                  if (
                                                      ...
                                                      console.warn(
                                                          `Unsupported bare value data type: "${
                                                              t.value
                                                          }".\nOnly valid data types are: ${Se.map(
                                                              (e) => `"${e}"`
                                                          ).join(", ")}.\n`
                                                      );
                                                      let r = t.value,
                            ...
                            : ke.test(t)
                            ? (r) => {
                                  r.utilities.static(t, () =>
                                      structuredClone(e.nodes)
                                  );
                              }
                            : null;
                    })(e);
                ...
                if ("@source" === e.name) {
                    ...
                    if (a) {
                        let e = o ? T : j,
                            t = R(l, " ");
                        for (let r of t) for (let t of Zt(r)) e.push(t);
            ...
            o = await (async function (e, t = {}) {
                ...
                return {
                    ...
                    build(o) {
                        ...
                        let m = He(u, r, { onInvalidCandidate: c }).astNodes;
                        return s || f !== m.length
                            ? ((f = m.length),
                              (i.nodes = m),
                              (d = T(n, r, t.polyfills)),
        ...
        try {
            let r = (function () {
                ...
                if (
                    ...
                    return { base: t, content: er.preflight };
                if (
                    "tailwindcss/theme" === e ||
                    "tailwindcss/theme.css" === e ||
                    "./theme.css" === e
                )
                    return { base: t, content: er.theme };
                if (
                    "tailwindcss/utilities" === e ||
                    "tailwindcss/utilities.css" === e ||
                    "./utilities.css" === e
                )
                    return { base: t, content: er.utilities };
                throw new Error(
                    `The browser build does not support @import for "${e}"`
                );
            })();
            return (
                sr.hit("Loaded stylesheet", {
                    id: e,
                    base: t,
            ...
            throw (
                (sr.hit("Failed to load stylesheet", {
                    id: e,
                    base: t,
                    error: r.message ?? r,
                }),
                ...
                sr.start(`Build #${t} (${e})`),
                    "full" === e &&
                        (await (async function () {
                            sr.start("Create compiler"),
                                sr.start("Reading Stylesheets");
    ...
    var fr = new MutationObserver(() => dr("full"));
    function pr(e) {
        fr.observe(e, {
            attributes: !0,
        ...
        for (let n of e) {
            for (let e of n.addedNodes)
                e.nodeType === Node.ELEMENT_NODE &&
                    "STYLE" === e.tagName &&
                    e.getAttribute("type") === rr &&
                    (pr(e), t++);
            for (let e of n.addedNodes) 1 === e.nodeType && e !== ar && r++;
            "attributes" === n.type && r++;
        }
        return t > 0 ? dr("full") : r > 0 ? dr("incremental") : void 0;
